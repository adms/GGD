...
import { resolveAbilityRange, enemiesInCircle } from "../abilities/abilitySystem";
import { normalize, sub, distSq } from "../math/vec2";
import {
  clampSpreadFalloff,
  clampSpreadRadius,
  clampSpreadTargets,
...
function applyEffect(e: EffectDef, ctx: EffectContext): void {
  ...
  switch (e.kind) {
    ...
    case "damageArea": {
      ...
      const victims: { id: import("../../ids").EntityId; d2: number }[] = [];
