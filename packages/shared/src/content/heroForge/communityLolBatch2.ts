...
export const COMMUNITY_LOL_BATCH2_EXAMPLES = ([
  {
    ...
    "moves": {
      "PASSIVE": {
        "name": "恆毅之泉",
        "purpose": "普通攻擊左右拳交替，右拳追加傷害；低血量時週期回血；承傷累積最多三層供 W 使用。",
