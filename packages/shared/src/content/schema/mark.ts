...
import "./effect"; // Preserve standalone mark parsing with registered nested effects.
import { zMarkLethalRule } from "./effects/_mark";
export { zMarkLethalRule } from "./effects/_mark";
