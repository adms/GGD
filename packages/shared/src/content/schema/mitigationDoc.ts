  ...
  .object({
    ...
    negativeResistAmplifyCeiling: z
      ...
      .describe(
        ...
        "護甲/魔抗被【破防】打成**負數**之後,受到的傷害最多放大到幾倍。2.0 = LoL(出貨值);1.0 = 關掉整個負分支,負抗性一律當成 0 —— 也就是這個功能出現之前的行為,調到 1.0 就是一鍵 rollback。⚠️ 它是**漸近極限**不是夾限:護甲 −100 時是 1.5 倍,−1000 時是 1.82 倍,永遠到不了 2。"
      ),
  })
  .strict();
