...
最新為八神庵 v2（revision 13→14）：補完其餘五槽，61 項本英雄／接續／Editor 案例及 12 項來源隔離回歸通過；四項有效突變均被攔截。紫炎由目標及施法者分開記錄，R 真正命中後才接有限連擊，完成後開同目標 EX 窗口；E 程式不變。整批 81 槽有案例、141 槽未對應、17 名通用普攻被動。模型／原文未改，原稿美術與新服務 ZIP／發布仍待完成，#1132 保持完整範圍。見 [收據](iori-verification.json)。
