...
最新為八神庵 E v1（revision 12→13）：真正三次輸入、0.2～1.2 秒窗口、逾時／控制中斷、首段成本與持續冷卻。其餘五槽待完成。模板原文與 hash 隨微調保留，伺服器歷史来源獨立核准；其他 36 份生成作品不變。整批 76 槽有案例、146 槽未對應、18 名通用普攻被動。見 [收據](iori-recast-verification.json)。
