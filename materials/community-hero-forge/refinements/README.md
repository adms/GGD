...
本輪已更新全部 37 名／222 槽，使用既有模板完成各自核心連動與惡搞代價；完整原稿及既有模型保留。最新入口為 [逐名表](parody-review.md)、[逐槽設定與處置](parody-review.json)、[版本清單](../handoff-manifest.json)。阿薩謝爾改為極大範圍嘲諷、兩秒敵方強化與三秒賢者時間。新版本的畫面、服務 ZIP 與正式發布須另驗，不沿用下列舊收據。
