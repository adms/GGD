...
最新為艾莉絲 v1：逐目標交鋒先手、踏步後斬擊、短效防禦、無傷害逼近、碰撞停止的光之太刀及自身近期命中 EX，revision 12→13。25 項行為、3 項試玩、四項有效突變通過；57 槽登記行為測試、165 槽未對應，20 名仍有通用普攻被動。見 [艾莉絲證據](eris-verification.json)。本尊模型及原生 clip 保留，專用動作／效果／音效畫面仍未驗收；#1132 原始完整範圍不變。
