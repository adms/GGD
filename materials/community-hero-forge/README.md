...
目前可供其他工作線使用的最新來源為 `c699a9ef51922e6dff101cac83bfec80952159d5`。武藤遊戲 revision 14→15、奇犽 revision 13→14；37 名／222 槽重編譯通過，33 槽已登記行為測試，189 槽尚未對應。武藤遊戲的召喚／布局／陷阱／EX 及奇犽攻擊回電修正見 [本批證據](refinements/yugi-verification.json)。**這是機制修正版，完整原設計、原作演出、當下服務 ZIP 與正式發布仍未完成。** 以下舊收據按各自版本閱讀。
