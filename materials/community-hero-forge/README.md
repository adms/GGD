...
目前可共用來源為 `1ede970a77514c967eb3df25412d6ea003fb0f06`。本批補上柯南 E 滑板加減速／急轉／碰撞與 EX 有限牽引，作品 revision 13→14；其餘 36 份作品、37 份原稿及模型綁定不變。37 名／222 槽重編譯通過，39 槽已登記行為測試、183 槽尚未對應，23 名仍有通用普攻被動。詳見 [柯南移動證據](refinements/conan-mobility-verification.json) 及 [前批四槽證據](refinements/conan-verification.json)。**完整原設計、專用素材畫面、當下服務 ZIP 與正式發布仍未完成。**
...
[index.json](index.json)＋[projects/](projects/) 已保存 37 份實際 HeroProject，配對既有 [recipes/](recipes/)；包含柯南六槽線索／投射物／睡眠／真相／滑板及有限牽引修正、奇犽六槽電力／有效迴避／限次反擊修正、鹿目圓希望／友軍保命與六槽修正、#1141 吉伊卡哇六槽機制與版本修正、#1140 御坂美琴電荷、EX 與單發／連鎖修正，#1139 風／樹 Q 切換及前批友軍盾、卡牌連結修正。逐檔版本與 SHA-256 在 [handoff-manifest.json](handoff-manifest.json)。**37 名／222 槽重新編譯通過；23 名仍有通用普攻被動，完整原設計、畫面與正式發布尚未完成**，詳見 [逐槽對照](refinements/design-audit.json) 及 #1132。
