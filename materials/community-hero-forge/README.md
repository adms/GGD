...
目前可共用來源為 `925f1350438df0ebf0b3e260bf148a097821b558`。八神庵 E「葵花」已改為三次獨立輸入，支援接續窗口、逾時／控制中斷、首段付費與持續冷卻，並接通 Editor 測試及遊戲技能列。作品 revision 12→13，其餘五槽仍待原設計修正。原模板來源已保留以支援重建及 rollback；其他 36 份作品、37 份原稿與全部模型綁定逐位元不變。37 名／222 槽編譯通過；76 槽登記行為測試、146 槽未對應，18 名仍有通用普攻被動。見 [葵花證據](refinements/iori-recast-verification.json)。**完整原設計、專用素材畫面、當下服務 ZIP 與正式發布仍未完成。**

乾淨提交 `526e26591c2d2703c816200ce6c3c07c833983a3` 同批通過 skills、Editor release、coord、37 名／222 槽編譯與模型核對；837 項登記測試及 Editor 601 項測試／正式建置通過。批次退出碼 2 保留 146 槽缺口；並非完整設計或畫面驗收通過。
...
[index.json](index.json)＋[projects/](projects/) 已保存 37 份實際 HeroProject，配對既有 [recipes/](recipes/)；包含銀時六槽補給／招架／打斷修正、柯南六槽線索／投射物／睡眠／真相／滑板及有限牽引修正、奇犽六槽電力／有效迴避／限次反擊修正、鹿目圓希望／友軍保命與六槽修正、#1141 吉伊卡哇六槽機制與版本修正、#1140 御坂美琴電荷、EX 與單發／連鎖修正，#1139 風／樹 Q 切換及前批友軍盾、卡牌連結修正。逐檔版本與 SHA-256 在 [handoff-manifest.json](handoff-manifest.json)。**37 名／222 槽重新編譯通過；18 名仍有通用普攻被動，完整原設計、畫面與正式發布尚未完成**，詳見 [逐槽對照](refinements/design-audit.json) 及 #1132。
