...
目前可共用來源為 `5a2b7d3f90af0a93f242b9075c309047e298b72c`。八神庵 v2 已補完紫炎、第一碰撞投射物、原地迎擊、R 有限連擊及同目標完成窗口的 EX；既有 E 三次輸入保持不變。作品 revision 13→14，其他 36 名作品、37 原稿與全部模型綁定逐位元不變。37 名／222 槽編譯通過；81 槽有登記案例、141 槽未對應，17 名仍有通用普攻被動。見 [八神庵機制證據](refinements/iori-verification.json)。**整批原設計、專用素材畫面、當下服務 ZIP 與正式發布仍未完成。**

本批乾淨提交 `e12c0be14a55480a3d1b4ea3bb498a68daa7597c` 同批通過 skills、Editor release、coord、37 名／222 槽編譯與模型核對；882 項登記測試及 Editor 601 項測試／正式建置通過。批次退出碼 2 保留 141 槽缺口；並非完整設計或畫面驗收通過。
...
[index.json](index.json)＋[projects/](projects/) 已保存 37 份實際 HeroProject，配對既有 [recipes/](recipes/)；包含銀時六槽補給／招架／打斷修正、柯南六槽線索／投射物／睡眠／真相／滑板及有限牽引修正、奇犽六槽電力／有效迴避／限次反擊修正、鹿目圓希望／友軍保命與六槽修正、#1141 吉伊卡哇六槽機制與版本修正、#1140 御坂美琴電荷、EX 與單發／連鎖修正，#1139 風／樹 Q 切換及前批友軍盾、卡牌連結修正。逐檔版本與 SHA-256 在 [handoff-manifest.json](handoff-manifest.json)。**37 名／222 槽重新編譯通過；17 名仍有通用普攻被動，完整原設計、畫面與正式發布尚未完成**，詳見 [逐槽對照](refinements/design-audit.json) 及 #1132。
