...
目前可共用來源為 `50a821472197fe480deb09b4f37b6bbfbd205f13`。本批柯南 PASSIVE／Q／W／R 修正，作品 revision 12→13；其餘 36 份作品、37 份原稿及模型綁定不變。37 名／222 槽重編譯通過，37 槽已登記行為測試、185 槽尚未對應，23 名仍有通用普攻被動。詳見 [柯南證據](refinements/conan-verification.json) 及 [前批武藤遊戲證據](refinements/yugi-verification.json)。**完整原設計、專用素材畫面、當下服務 ZIP 與正式發布仍未完成。**
...
[index.json](index.json)＋[projects/](projects/) 已保存 37 份實際 HeroProject，配對既有 [recipes/](recipes/)；包含柯南線索／足球碰撞／傷害喚醒睡眠／真相四槽修正、奇犽六槽電力／有效迴避／限次反擊修正、鹿目圓希望／友軍保命與六槽修正、#1141 吉伊卡哇六槽機制與版本修正、#1140 御坂美琴電荷、EX 與單發／連鎖修正，#1139 風／樹 Q 切換及前批友軍盾、卡牌連結修正。逐檔版本與 SHA-256 在 [handoff-manifest.json](handoff-manifest.json)。**37 名／222 槽重新編譯通過；23 名仍有通用普攻被動，完整原設計、畫面與正式發布尚未完成**，詳見 [逐槽對照](refinements/design-audit.json) 及 #1132。
