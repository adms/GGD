...
目前可共用來源為 `3990c5c863e4dbcc3e4ca5ff81aabada33b8d897`。不知火舞六槽已接入同一 JSON 微調及批次驗證：一次身法、實體穿透彈、前方火焰弧、沿途碰撞突進、有效接觸後連段與有限殘像追加，作品 revision 12→13。其餘 36 份作品、37 份原稿及全部模型綁定不變。37 名／222 槽重新編譯通過；75 槽登記行為測試、147 槽尚未對應，18 名仍有通用普攻被動。見 [不知火舞證據](refinements/mai-verification.json)。**完整原設計、專用素材畫面、當下服務 ZIP 與正式發布仍未完成。**
