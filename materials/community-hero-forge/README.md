...
目前可共用來源為 `7586263e5f8197aadbd9d714f9fb7ffebcd0618a`。阿薩謝爾第 32 份作品已接入同一 JSON 微調及批次驗證，萎靡／反轉改用實際傷害輸出倍率，近身反擊改依有效受擊且不額外免傷。作品 revision 30→31，其餘 36 份作品、37 份原稿及全部模型綁定不變；兩個交接入口的 37 份作品逐位元組一致。37 名／222 槽重新編譯通過；69 槽登記行為測試、153 槽尚未對應，19 名仍有通用普攻被動。見 [阿薩謝爾本批證據](refinements/azazel-batch-verification.json)。**完整原設計、專用素材畫面、當下服務 ZIP 與正式發布仍未完成。**
...
[index.json](index.json)＋[projects/](projects/) 已保存 37 份實際 HeroProject，配對既有 [recipes/](recipes/)；包含銀時六槽補給／招架／打斷修正、柯南六槽線索／投射物／睡眠／真相／滑板及有限牽引修正、奇犽六槽電力／有效迴避／限次反擊修正、鹿目圓希望／友軍保命與六槽修正、#1141 吉伊卡哇六槽機制與版本修正、#1140 御坂美琴電荷、EX 與單發／連鎖修正，#1139 風／樹 Q 切換及前批友軍盾、卡牌連結修正。逐檔版本與 SHA-256 在 [handoff-manifest.json](handoff-manifest.json)。**37 名／222 槽重新編譯通過；22 名仍有通用普攻被動，完整原設計、畫面與正式發布尚未完成**，詳見 [逐槽對照](refinements/design-audit.json) 及 #1132。
