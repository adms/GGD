...
- Samus c00 macOS Blender 5.2.1 收據：blocked-tool-init-crash；`materials/hero-model-library/priority-evidence/ssbu-samus-blender522-macos-blocker-v1/receipt.json`。Blender 5.2.1 crashes in Metal/GPU backend initialization before the converter can open the source; no GLB, conversion receipt, candidate, registration, runtime option, or deployment exists.
