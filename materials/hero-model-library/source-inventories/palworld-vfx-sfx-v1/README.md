...
目前共 27 個去重來源技能、70 段技能動作候選、18 段一般叫聲；取得的獨立 VFX 與技能專屬 SFX 都是 0。沒有新增 runtime 綁定，也沒有宣稱部署。

| 角色 | 來源技能 | 技能動作候選 | 獨立 VFX | 技能專屬 SFX | 一般叫聲 |
|---|---:|---:|---:|---:|---:|
| 空渦龍／Jetragon | 10 | 8 | 0 | 0 | 6 |
| 枯星龍／Astralym | 9 | 54 | 0 | 0 | 6 |
| 搗蛋貓／Cattiva | 8 | 8 | 0 | 0 | 6 |
...
[unused-assets.json](unused-assets.json) 保存 18 段一般叫聲；目前沒有可列入的獨立 VFX 或道具，不能用空索引冒充已取得。
