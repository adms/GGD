...
- 另有 `3` 個 MBA 六態標準化候選，包含 `18` 段明確選取的原生動作；候選尚未通過視覺審查或登記下拉。
...
|---|---:|---:|---:|---:|---|---|
| 白蛇娜卡 | 3,587 | 1 | 33 | 1 | `wait, F-Move, attack_01, sp01_01, Damage-1, D-Down` | 已標準化候選；待視覺審查、待英雄設計 |
| 八神疾風 | 4,282 | 1 | 27 | 1 | `wait, F-Move, attack_01, sp01_01, Damage-1, D-Down` | 已標準化候選；待視覺審查、待英雄設計 |
| 薇塔 | 4,412 | 1 | 26 | 1 | `wait, F-Move, attack_01, sp01_01, Damage-1, D-Down` | 已標準化候選；待視覺審查、待英雄設計 |
