...
| Worldblender body 候選 | 128 | 16 | 128 個原始 `.blend`；其中 10 個 c00 已轉 GLB | 0 個已驗收動作 | 10 個靜態元件 | 0 個 |
| NSandNS2 遊戲容器 | 3 | 0 | 0 | 0 | 0 | 0 |

另一來源 Worldblender 的這 16 名，每人已有 c00–c07 body Blender 候選，共 128 份。目前已對 庫洛姆 c00、黛西 c00、加儂多夫 c00、卡比 c00、林克 c00、露琪娜 c00、瑪利歐 c00、碧姬公主 c00、索尼克 c00、卡通林克 c00 重算 SHA，並以 Blender 4.5.13 與 GGD 正式流程完成兩次位元組相同建置、Khronos／預算／三視圖驗收。這 10 個仍是沒有動作的獨立靜態蒙皮元件；英雄綁定、後台選項與部署都是 0。其餘 118 份仍僅核對存在與大小。Ultimate14 本身不含完整角色本體。
