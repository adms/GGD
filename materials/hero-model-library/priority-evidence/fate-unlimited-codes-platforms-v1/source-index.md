...
- PS2 公開音訊來源：3 組，共 653 個 WAV；已逐檔讀取並核對 673 筆／245398120 bytes 的大小與 SHA-256，角色／事件仍待逐段聽審。
- PS2 原作光碟與 Arcade 原始資料：尚未找到實檔。
- PSP GMO 工具參考樣本：21 個 GMO／258 個動作區塊；來源遊戲未核，檔名指向 Dissidia 系列，且驗證收據明列 FUC 原生包為 0，只能測格式工具。
