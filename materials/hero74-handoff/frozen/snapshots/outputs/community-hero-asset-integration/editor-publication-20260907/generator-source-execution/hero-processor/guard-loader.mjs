...
export async function resolve(specifier, context, next) {
  ...
  if (result.url.startsWith("file:///private/tmp/ggd-source-execution-ZSb7yE/hero-processor/") && result.url.includes('/packages/shared/src/')) appendFileSync("/private/tmp/ggd-source-execution-ZSb7yE/hero-processor/loaded-sources.txt", result.url + '\n');
  return result;
}