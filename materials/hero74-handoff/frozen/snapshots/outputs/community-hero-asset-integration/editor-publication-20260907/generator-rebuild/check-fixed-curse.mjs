...
const out='/private/tmp/ggd-community37-generator-rebuild/32';const proof=JSON.parse(await readFile(out+'/review.json','utf8'));const c=await connect('02B883304E6A5424B24704EA5CAAB195');const wait=ms=>new Promise(r=>setTimeout(r,ms));
