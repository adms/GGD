...
export interface HookDef {
  /** An exclusive, one-use active interception before shields and life saving. */
  defenseWindow?: boolean;
  damageDelivery?: import("../combat/hitDelivery").HitDeliveryFilter;
...
export interface ModifierSource {
  /** Skill which granted a defensive window; presentation provenance only. */
  defenseAbilityId?: AbilityId;
