...
`receipts/` 記錄實際 target、來源摘要及環境；執行中的編譯服務為 `417abec9d90424b5ccbe7948331a60f98dd0f689`。本整合分支基於 main `256758741`。收據證明對該服務執行過操作，不宣稱已部署這個較新的 main，也不把收據核對當成重跑 SimWorld 或原作素材验收。正式部署後仍以新服務的 target 重建 ZIP。
