...
*由 `pnpm docs:readme` 從 contentVersion `cv_70e7186a863c` 產生。 開放 49 / 全 78 名。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_70e7186a863c` 產生。 開放英雄技能 293 / 全 461 個。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:abilities -->

<!-- BEGIN GENERATED:items -->
#### 商店貨架 + 抽卡池（能實際取得的道具）

> 全部 219 件道具依 `craftRole` 標記分類（task #70）。**真正能買的只有 38 件最終合成武器＋2 項服務**；三選一 draft 抽 13 件任務道具、傳說寶玉抽 49 件傳說。其餘 149 件是配方組件、代幣、殘件或還沒 payload 的 final，不會單獨出現在商店或抽卡。
>
...
*由 `pnpm docs:readme` 從 contentVersion `cv_70e7186a863c` 產生。 可取得 102 / 全 219 件。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:items -->
...
*由 `pnpm docs:readme` 從 contentVersion `cv_70e7186a863c` 產生。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:grail -->
