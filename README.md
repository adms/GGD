...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 倍率讀 `content/config/combat-env.json`（version 9）。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 輪替 12 / 全 13 張。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 級距與 `appliesTo` 讀 `content/config/stat-normalization.json`、上限讀 `stat-caps.json`、成長現況現場數 `content/champions/`。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 級距讀 `content/config/*-tiers.json`（7 張表）、母體讀 `docs/平衡錨點量測.md`。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:tiers -->
...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 開放 49 / 全 71 名。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 開放英雄技能 293 / 全 420 個。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 可取得 130 / 全 142 件。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:items -->
...
*由 `pnpm docs:readme` 從 contentVersion `cv_37e2cc610b34` 產生。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:grail -->
...
| `damage` | 161 | `damageArea` | 38 | `damageLine` | 12 |
| `dash` | 7 | `delayed` | 12 | `devour` | 3 |
| `dispel` | 8 | `dot` | 3 | `evasion` | 0 |
| `eventValueConversion` | 5 | `extendBuff` | 1 | `floatingText` | 5 |
| `grantAttribute` | 5 | `grantGold` | 1 | `heal` | 10 |
| `invulnerable` | 16 | `knockback` | 12 | `leap` | 7 |
| `manaBarrier` | 1 | `modifyCooldown` | 13 | `proxyCast` | 6 |
| `pull` | 0 | `randomArea` | 6 | `restore` | 17 |
| `revive` | 1 | `screenFlash` | 2 | `screenShake` | 11 |
| `shield` | 10 | `shieldBreak` | 2 | `spawnModelFx` | 9 |
| `spawnProjectile` | 24 | `spawnVfx` | 23 | `spendMana` | 4 |
