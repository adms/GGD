...
*由 `pnpm docs:readme` 從 contentVersion `cv_6fbc4aae62ba` 產生。 倍率讀 `content/config/combat-env.json`（version 9）。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_6fbc4aae62ba` 產生。 輪替 12 / 全 13 張。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
| 生命 | 4074.6 | 6519.36 | 8149.2 | 10186.5 | 16298.4 | 402129 | 402129 | ✅ |
| 裝甲 | 45.05 | 72.07 | 90.09 | 112.61 | 180.18 | 4620 | 4620 | ✅ |
| 魔抗 | 129.35 | 206.96 | 258.7 | 323.38 | 517.4 | 15311 | 15311 | ✅ |
| 魔力 | 2492.75 | 3988.4 | 4985.5 | 6231.88 | 9971 | 240323 | 240323 | ✅ |
...
*由 `pnpm docs:readme` 從 contentVersion `cv_6fbc4aae62ba` 產生。 級距與 `appliesTo` 讀 `content/config/stat-normalization.json`、上限讀 `stat-caps.json`、成長現況現場數 `content/champions/`。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
- `content/champions/` 的 153 份是**這個 repo 有的東西**（另有 48 份在 `_legacy/champions/`，**不進出貨 bundle**）。
...
| 耗魔 | `manaCostTier` | `manaCost` | **56** | **112** | **224** | **448** | **896** | ✅ | `mana-tiers.json` |
...
*由 `pnpm docs:readme` 從 contentVersion `cv_6fbc4aae62ba` 產生。 級距讀 `content/config/*-tiers.json`（9 張表）、母體讀 `docs/平衡錨點量測.md`。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:tiers -->
...
**`community-review-01-20260907` 武藤遊戲**（mage · 遠程） — 武藤遊戲 社群英雄功能驗收稿。作品：《遊戲王》

- **天生·被動** 〔決鬥者的布局〕：召喚物命中與陷阱成功觸發，各累積布局；每次施法最多增加一層，上限三…
...
**`community-review-02-20260907` 八神庵**（fighter · 近戰） — 八神庵 社群英雄功能驗收稿。作品：《THE KING OF FIGHTERS》

- **天生·被動** 〔八神之炎〕：不同主動技能連續命中同一敵人，累積最多三層紫炎；下一次終結技消耗層…
...
**`community-review-03-20260907` 不知火舞**（fighter · 近戰） — 不知火舞 社群英雄功能驗收稿。作品：《THE KING OF FIGHTERS》

- **天生·被動** 〔不知火流身法〕：完成位移後獲得一次短效普攻強化；刷新不疊加。
...
**`community-review-04-20260907` 空條承太郎**（fighter · 近戰） — 空條承太郎 社群英雄功能驗收稿。作品：《JoJo 的奇妙冒險》

- **天生·被動** 〔白金之星・精密動作〕：近距離命中累積精密層數；滿層後強化下一次 Q 的末擊。
...
**`community-review-05-20260907` 洛克人**（marksman · 遠程） — 洛克人 社群英雄功能驗收稿。作品：《Mega Man》

- **天生·被動** 〔武器能源管理〕：特殊武器共用有限能源；能源隨時間恢復，切換武器不補滿。
...
**`community-review-06-20260907` 卡比**（tank · 近戰） — 卡比 社群英雄功能驗收稿。作品：《星之卡比》

- **天生·被動** 〔圓滾滾的韌性〕：脫離戰鬥後逐步恢復少量生命；受擊即中斷。
- **Q** 吸入：【目前模板可執行】拖拉指定目標後向前投擲 120 wc3u，0.4…
...
**`community-review-07-20260907` 西索**（fighter · 近戰） — 西索 社群英雄功能驗收稿。作品：《HUNTER×HUNTER》

- **天生·被動** 〔魔術師的節奏〕：以不同技能命中同一目標，強化下一次撲克牌攻擊；最多保存一次。
- **Q** 〔撲克牌連射〕：【目前模板可執行】在指定區域依序落下 3 發；每發間隔 0.12…
- **W** 伸縮自在的愛：【目前模板可執行】指定單一敵人造成小級魔法傷害。 附加效果：[{"…
- **E** 〔收線〕：【目前模板可執行】拖拉指定目標後向前投擲 120 wc3u，0.4…
- **R** 〔彈性殺陣〕：【目前模板可執行】指定落點半徑中 wc3u 的一次小級範圍傷害。
- **EX** 輕薄的假象：在地面製作一個假的陷阱外觀，或改變自身表面外觀。偽裝不改變真實陣營…

**`community-review-08-20260907` 米卡莎**（fighter · 近戰） — 米卡莎 社群英雄功能驗收稿。作品：《進擊的巨人》

- **天生·被動** 〔阿卡曼戰鬥直覺〕：成功避開攻擊後，下一次刀刃命中獲得有限增傷；有觸發間隔。
...
**`community-review-09-20260907` 赫蘿**（fighter · 遠程） — 赫蘿 社群英雄功能驗收稿。作品：《狼與辛香料》

- **天生·被動** 〔賢狼的眼光〕：參與有效助攻獲得交易籌碼，上限三枚；同一擊殺事件只結算一次。
...
**`community-review-10-20260907` 魯路修**（fighter · 遠程） — 魯路修 社群英雄功能驗收稿。作品：《Code Geass 反叛的魯路修》

- **天生·被動** 〔戰局推演〕：友軍命中自己的戰術標記時累積指揮層數，同一技能多段命中只計一次。
...
**`community-review-11-20260907` 利姆路**（mage · 近戰） — 利姆路 社群英雄功能驗收稿。作品：《關於我轉生變成史萊姆這檔事》
...
**`community-review-12-20260907` 衛宮士郎**（mage · 近戰） — 衛宮士郎 社群英雄功能驗收稿。作品：《Fate/stay night》

- **天生·被動** 〔武器解析〕：近戰交鋒累積解析層數，降低下一次投影的資源消耗；有最低消耗限制。
...
**`community-review-13-20260907` 朝田詩乃**（marksman · 遠程） — 朝田詩乃 社群英雄功能驗收稿。作品：《刀劍神域》

- **天生·被動** 〔狙擊專注〕：保持穩定姿勢累積瞄準，移動或受擊降低；效果有上限。
...
**`community-review-14-20260907` 殺老師**（fighter · 近戰） — 殺老師 社群英雄功能驗收稿。作品：《暗殺教室》
...
**`community-review-15-20260907` 比利海靈頓**（tank · 近戰） — 比利海靈頓 社群英雄功能驗收稿。來源：摔角與網路迷因形象。

- **天生·被動** 〔兄貴的氣勢〕：成功抓取或保護友軍累積氣勢，上限三層。
- **Q** 〔正面擒抱〕：【目前模板可執行】指定單一敵人造成小級物理傷害。
- **W** 〔肌肉防線〕：【目前模板可執行】拖拉指定目標後向前投擲 200 wc3u，0.4…
- **E** 〔肩膀衝撞〕：【目前模板可執行】自身取得 3 秒增益：無屬性加成；另結算下列護盾…
- **R** 〔兄貴背摔〕：【目前模板可執行】拖拉指定目標後向前投擲 400 wc3u，0.4…
- **EX** 〔兄弟站起來〕：為附近友軍提供護盾與短效韌性，以振奮及健美姿勢演出。

**`community-review-16-20260907` 魔法少女☆伊莉雅**（mage · 遠程） — 魔法少女☆伊莉雅 社群英雄功能驗收稿。作品：《Fate/kaleid line…

- **天生·被動** 〔紅寶石的支援〕：不同魔法技能連續施放後，強化下一次防禦或攻擊，不能由同一次多段命中…
...
**`community-review-17-20260907` 安茲·烏爾·恭**（mage · 遠程） — 安茲·烏爾·恭 社群英雄功能驗收稿。作品：《OVERLORD》
...
**`community-review-18-20260907` 吉爾伽美什**（marksman · 遠程） — 吉爾伽美什 社群英雄功能驗收稿。作品：《Fate》

- **天生·被動** 〔王的財庫〕：技能按次累積財庫能量，供 EX 消耗；命中段數不等於獲得次數。
...
**`community-review-19-20260907` 桐谷和人**（fighter · 近戰） — 桐谷和人 社群英雄功能驗收稿。作品：《刀劍神域》

- **天生·被動** 二刀流：交替命中累積連擊節奏，停止交鋒後衰退；提供有限攻速加成。
...
**`community-review-20-20260907` 御坂美琴**（mage · 遠程） — 御坂美琴 社群英雄功能驗收稿。作品：《科學超電磁砲》

- **天生·被動** 〔電荷累積〕：不同技能命中累積電荷，上限三層；下一次強化技消耗。
...
**`community-review-21-20260907` 鹿目圓**（fighter · 遠程） — 鹿目圓 社群英雄功能驗收稿。作品：《魔法少女小圓》

- **天生·被動** 〔希望的連結〕：有效保護友軍時累積希望，上限三層；溢出治療與無效護盾不提供資源。
...
**`community-review-22-20260907` 菜月昴**（tank · 近戰） — 菜月昴 社群英雄功能驗收稿。作品：《Re:從零開始的異世界生活》

- **天生·被動** 〔記住這次失敗〕：完成一次死亡回歸後，短暫標記造成致死傷害的敵人；只顯示當前合法可見…
- **Q** Shamac：【目前模板可執行】指定單一敵人造成小級魔法傷害。 附加效果：[{"…
- **W** 〔鞭繩牽制〕：【目前模板可執行】拖拉指定目標後向前投擲 100 wc3u，0.4…
- **E** 〔重新振作〕：【目前模板可執行】自身取得 3 秒增益：無屬性加成；另結算下列護盾…
- **R** 死亡回歸：【目前模板可執行】自身取得 3 秒增益：無屬性加成；另結算下列護盾…
- **EX** 〔重新選擇〕：R 存檔有效且自己仍存活時，主動消耗同一存檔，回復位置與受上限限制…

**`community-review-23-20260907` 坂田銀時**（fighter · 近戰） — 坂田銀時 社群英雄功能驗收稿。作品：《銀魂》

- **天生·被動** 〔糖分補給〕：脫戰後累積一份補給，供 W 消耗；最多保存一份。
...
**`community-review-24-20260907` 奇犽**（fighter · 近戰） — 奇犽 社群英雄功能驗收稿。作品：《HUNTER×HUNTER》

- **天生·被動** 〔電力儲備〕：技能消耗電力；停止攻擊一段時間後逐步充電，設上限。
...
**`community-review-25-20260907` 一拳超人**（fighter · 近戰） — 一拳超人 社群英雄功能驗收稿。作品：《一拳超人》

- **天生·被動** 〔興趣使然的英雄〕：一段時間未攻擊後，下一次普通拳獲得有限強化。
...
**`community-review-26-20260907` 名偵探柯南**（marksman · 遠程） — 名偵探柯南 社群英雄功能驗收稿。作品：《名偵探柯南》

- **天生·被動** 〔線索整理〕：對已觀察敵人收集最多三條線索，每種有效戰鬥事件只計一次。
...
**`community-review-27-20260907` 庫洛魔法使**（fighter · 遠程） — 庫洛魔法使 社群英雄功能驗收稿。作品：《庫洛魔法使》

- **天生·被動** 〔卡牌連結〕：依序使用不同卡牌累積連結，上限三層，強化下一次護盾。
...
**`community-review-28-20260907` 艾莉絲·伯雷亞斯·格雷拉特**（fighter · 近戰） — 艾莉絲·伯雷亞斯·格雷拉特 社群英雄功能驗收稿。作品：《無職轉生》

- **天生·被動** 〔劍神流・先發制人〕：對剛進入交鋒的目標，首次近戰命中獲得有限強化；同一目標有冷卻。
...
**`community-review-29-20260907` 芙莉蓮**（mage · 遠程） — 芙莉蓮 社群英雄功能驗收稿。作品：《葬送的芙莉蓮》

- **天生·被動** 魔力抑制：降低敵方魔力感知類技能取得的強度資訊；不等同隱形，也不隱藏基本敵我…
...
**`community-review-30-20260907` 尼古貓貓**（mage · 遠程） — 尼古貓貓 社群英雄功能驗收稿。作品識別：《ヤニねこ／尼古喵喵》

- **天生·被動** 〔拖延症〕：停止移動後逐步累積拖延，上限三層；受擊時清空，施法可消耗強化。
...
**`community-review-31-20260907` SUN樂**（fighter · 近戰） — SUN樂 社群英雄功能驗收稿。作品：《香格里拉・開拓異境》

- **天生·被動** 〔糞作獵人的讀招〕：成功以位移避開有效攻擊後，獲得一層讀招，上限三層。單純空按移動不增…
...
**`community-review-32-20260907` 阿薩謝爾**（mage · 近戰） — 阿薩謝爾 社群英雄功能驗收稿。作品：《召喚惡魔／よんでますよ、アザゼルさん。》

- **天生·被動** 淫奔：轉譯為「負面能量」資源。對敵人造成有效技能傷害時累積，最多三層，每…
...
**`community-review-33-20260907` 近衛刀太**（fighter · 近戰） — 近衛刀太 社群英雄功能驗收稿。作品：《UQ HOLDER!》
...
**`community-review-34-20260907` 高速婆婆**（fighter · 近戰） — 高速婆婆 社群英雄功能驗收稿。作品：《膽大黨》

- **天生·被動** 〔追上你了〕：持續追逐同一可見目標時累積速度，轉換目標、失去視線或停止追逐後衰退。
...
**`community-review-35-20260907` 炭治郎**（fighter · 近戰） — 炭治郎 社群英雄功能驗收稿。作品：《鬼滅之刃》

- **天生·被動** 〔嗅覺・破綻辨識〕：成功閃過敵人攻擊後，短暫顯示該敵人的近身破綻；下一次刀技命中消耗。
...
**`community-review-36-20260907` 鬼畜王蘭斯**（fighter · 近戰） — 鬼畜王蘭斯 社群英雄功能驗收稿。作品：《鬼畜王蘭斯／Rance》

- **天生·被動** 〔自信過剩〕：參與擊殺獲得當回合戰意，上限五層，提升有限近戰能力。
...
**`community-review-37-20260907` 吉伊卡哇**（tank · 近戰） — 吉伊卡哇 社群英雄功能驗收稿。作品：《吉伊卡哇》

- **天生·被動** 〔雖然害怕還是努力〕：附近友軍交戰時累積勇氣，上限三層；以時間間隔累積，避免多段傷害快速…
...
- **E** 22-03 五吋釘：將一枚充滿詛咒的五吋釘射向敵方目標，造成瞬間500/750/100…
...
- **Q** 21-02 拔焰刀：拔抽覆蓋火焰的刀斬擊敵人造成500/750/1000傷害，同時可以…
...
- **Q** 01-01 凶斬：使用大刀在敵人身上刻下凶字造成500/750/1000/1250/…
- **W** 01-02 隕石擊：招喚隕石擊落攻擊區域內的敵人造成100傷害並且跳躍到該範圍給予斬殺…
- **E** 01-03 畫龍點睛：快速迴旋巨劍產生龍捲風砍殺敵人造成500/750/1000/125…
...
- **Q** 90-01 飛葉快刀：發出飛快的葉子進行攻擊，每秒對附近的敵人造成250/375/500…
...
| **初音**<br>`godie-o02p` | 夢幻之星 | ✅ | 99-00 可愛就是正義 | 99-01 甩蔥歌 | 99-02 最初的聲音 | 99-03 初音未來的消失 | 99-04 世界第一的公主殿下 | 99-002 把你給MikuMiku掉 |
| **臭作**<br>`godie-o030` | 電車癡漢 | — | 30-00 攝影機 | 30-01 綁架 | 30-02 酒精灌腸 | 30-03 痴漢火焰 | 30-04 電車之狼衝擊 | 30-002 變態紳士 |
...
| **拳四郎**<br>`godie-u00l` | 北斗之鼠 | — | 25-00 北斗暗殺拳 | 25-01 北斗懺悔拳 | 25-02 北斗神拳秘訣轉龍呼吸法 | 25-03 北斗百裂拳 | 25-04 ChangeDNA | 25-002 喔拉喔拉喔拉喔拉 |
| **蒙其.D.魯夫**<br>`godie-u00n` | 草帽小子 | ✅ | 76-00 二檔 | 76-01 伸縮自如的橡膠戰斧 | 76-02 伸縮自如的橡膠火箭砲 | 76-03 伸縮自如的槍亂打 | 76-04 三檔.巨人迴旋彈 | 76-002 霸王色 |
| **蒙其.D.魯夫**<br>`godie-u00o` | 草帽小子 | — | 76-00 二檔 | 76-01 伸縮自如的橡膠戰斧 | 76-02 伸縮自如的橡膠火箭砲 | 76-03 伸縮自如的槍亂打 | 76-04 三檔.巨人迴旋彈 | 76-002 霸王色 |
| **基廉列克**<br>`godie-u00v` | 黑手黨老大 | ✅ | 78-00 銅皮鐵骨 | 78-01 斬鐵拳 | 78-02 地走龍牙破 | 78-03 廬山昇龍破 | 78-04 死亡噴射肘擊 | 78-002 加速爆體 |
| **飛影**<br>`godie-u010` | 邪眼師 | — | 38-00 邪眼全開 | 38-01 邪王炎殺劍 | 38-02 邪王炎殺煉獄焦 | 38-03 邪王炎殺黑龍波 | 38-04 黑龍波吸收 | 38-002 究極暴走黑龍波 |
| **索隆**<br>`godie-u01u` | 三刀流劍士 | — | 11-00 三刀流 | 11-01 燒鬼斬 | 11-02 虎狩獵 | 11-03 鬼氣九刀流-阿修羅壹霧銀 | 11-04 三千世界 | 11-002 武裝色霸氣 |
| **傑 富力士**<br>`godie-u034` | 職業獵人 | — | 06-00 猜猜拳 | 06-01 山形修煉-放 | 06-02 山形修煉-變 | 06-03 山形修煉-強 | 06-04 傑桑變化 | 06-002 殺意 |
...
| **梅普露（變身）**<br>`b2-maple-alt-9769eb88b85b` | — | — | 客服固定金額回禮 | 防禦力輸入多一個零 | 盾後補餐退魔力 | 這個形狀看起來很耐打 | 怪物模式限定毒龍包 | 大家躲我後面不要推 |
...
*由 `pnpm docs:readme` 從 contentVersion `cv_6fbc4aae62ba` 產生。 開放英雄技能 779 / 全 907 個。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
...
*由 `pnpm docs:readme` 從 contentVersion `cv_6fbc4aae62ba` 產生。 可取得 130 / 全 142 件。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:items -->
...
*由 `pnpm docs:readme` 從 contentVersion `cv_6fbc4aae62ba` 產生。 這三段標記之間的任何字都會在下次重新產生時被覆蓋。*
<!-- END GENERATED:grail -->
...
| `shieldBreak` | 2 | `spawnModelFx` | 55 | `spawnObstacle` | 0 |
| `spawnProjectile` | 4 | `spawnThresholds` | 0 | `spawnVfx` | 60 |
| `spendHealth` | 4 | `spendMana` | 6 | `summon` | 8 |
| `swapResource` | 1 | `taunt` | 2 | `weightedBranch` | 13 |
