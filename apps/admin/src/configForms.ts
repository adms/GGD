...
const VFX_CLEANUP_SPEC: ConfigDocSpec = {
  ...
  fields: [
    ...
    },
    {
      ...
      zh: "🔬 多長幾個才算「還在長」",
      note: "警報門檻，⛔ 不是清理門檻。一類東西要**同時**滿足三件事才會被指名：①逐回合單調不減 ②最新 − 最舊 ≥ 這個數字 ③**最後一段仍然在增**。第三條是刻意的：一個**有界的快取**（例如地面貼圖，每種風格 4 張、出貨 8 種＝ 32 張封頂，實測第 10 回合就平了）長到頂之後警報就該熄 —— ⛔ 一個一直亮著的警報等於沒有警報。調小＝更敏感也更容易被暖機波動觸發；調大＝只抓大魚。",
    },
    {
