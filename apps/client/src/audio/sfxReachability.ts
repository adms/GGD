...
/**
 * ⭐ GH#529 —— 技能施法音的**決定點也是 JSON**（同 `VFX_SOUND_SITE` 的理由）。
 * 那 52 個 cue 名字在 2026-08-22 之前是 `combatSfx.ts` 裡的一個字面值 `Set`；
 * owner 2026-08-20：「⋯**特效音效綁定**⋯都請整理更新到 **JSON**」。
 */
const ABILITY_SFX_CUES_SITE = "content/audio-manifests/ability-sfx-cues.json";
...
export const SFX_REACHABILITY: readonly SfxReachRow[] = [
  ...
  // ⭐ GH#529 —— `site` 指的是 **JSON**：cue 名單住 `ability-sfx-cues.json`,
  //    ⛔ 不再是 combatSfx.ts 裡的一個字面值 Set。刪掉那份 JSON 的一列 → 這裡紅。
  { key: "wc3.moongo", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.moonjump", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.nocute", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  ...
  { key: "wc3.akamapissed8", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.altarofelderswhat1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.axemissilelaunch1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.chickenwhat1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.darksummoninglaunch1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.defendcaster", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.demonhuntermissilehit3", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.dragonroostwhat1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.dragonyes2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.druidofthetalonmissilelaunch2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.eggsackdeath1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.flaretarget2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.flaretarget3", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.gluescreenmeteorhit1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.gruntpissed3", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.gruntyesattack1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.gruntyesattack3", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.hcancelbuilding", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.headhunteryes4", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.kaelyesattack3", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.markofchaos", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.mercenarywhat1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.mortarimpact", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.mortarteampissed9", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.nazgrelyes2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.necropolisupgrade2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.pandarenbrewmasterpissed8", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.pandarenbrewmasterwarcry1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.pandarenbrewmasteryes1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.parasite", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.peasantpissed3", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.peondeath", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.rokhanwhat2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.sealwhat2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.shadowhunterready1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.shamanready1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.snapdragonmissilelaunch1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.soulgem", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.soulpreservation", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.spellbreakerpissed4", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.spiritofvengeanceyes3", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.stampedecaster1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.taunt", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.thunderboltmissiledeath", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.thunderclapcaster", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.treantready1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.trollbatriderpissed2", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.trollwoodworkswhat1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
  { key: "wc3.waygatewhat1", kind: "combat", site: ABILITY_SFX_CUES_SITE, events: ["abilityCast"], payload: { abilityCast: ["sfxKey"] } },
