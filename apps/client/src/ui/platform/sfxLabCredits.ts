...
const SFX_LAB_SOURCE: readonly SfxLabClipSource[] = [
  ...
  { file: "sfx/lab/gold-gain.mp3", mapKeys: ["coinDrop", "goldGain"], title: "お金を落とす1", sourceFile: "money-drop1.mp3", url: "https://soundeffect-lab.info/sound/various/mp3/money-drop1.mp3", page: "https://soundeffect-lab.info/sound/various/", use: "取得金幣 / 陣亡投幣落地", group: "ui" },
  ...
  { file: "sfx/lab/recessBell.mp3", mapKeys: [], title: "学校のチャイム", sourceFile: "school-chime1.mp3", url: "https://soundeffect-lab.info/sound/anime/mp3/school-chime1.mp3", page: "https://soundeffect-lab.info/sound/anime/", use: "備而未用：原為中場「下課鐘」，#190 起商店只播 BGM 不再鳴鐘（26 秒的鐘聲蓋掉了 60 秒備戰視窗的音樂）。素材仍隨遊戲附帶並保留出處", group: "stage" },
  ...
  { file: "sfx/lab/guardianLastHit.mp3", mapKeys: ["coinPickup", "guardianLastHit"], title: "アイテムを入手1", sourceFile: "item-get1.mp3", url: "https://soundeffect-lab.info/sound/anime/mp3/item-get1.mp3", page: "https://soundeffect-lab.info/sound/anime/", use: "守衛塔最後一擊的金幣獎勵 / 撿起地上的金幣", group: "stage" },
  ...
  { file: "sfx/lab/zombie-roar.mp3", mapKeys: ["zombieRoar"], title: "ゾンビの声3", sourceFile: "zombie-voice3.mp3", url: "https://soundeffect-lab.info/sound/battle/mp3/zombie-voice3.mp3", page: "https://soundeffect-lab.info/sound/battle/battle2.html", use: "殭屍王 [leap吸血] 起跳前的咆哮（全畫面轉黑那一秒）", group: "magic" },
  { file: "sfx/lab/zombie-bite.mp3", mapKeys: ["zombieBite"], title: "ゾンビに体をえぐられる", sourceFile: "zombie-beat1.mp3", url: "https://soundeffect-lab.info/sound/battle/mp3/zombie-beat1.mp3", page: "https://soundeffect-lab.info/sound/battle/battle2.html", use: "殭屍王 [leap吸血] 落地咬下去的那一口（同時噴血）", group: "magic" },
