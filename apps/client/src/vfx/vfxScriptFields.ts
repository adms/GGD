...
export const FIELDS: Record<VfxScriptSegment["kind"], FieldSpec[]> = {
  ...
  beam: [
    ...COMMON,
    { key: "at", label: "起點", kind: "select", options: ["caster", "target", "point"] },
    { key: "lengthU", label: "視覺長度 u", kind: "range", min: 0.5, max: 40, step: 0.1 },
    { key: "widthU", label: "視覺寬度 u", kind: "range", min: 0.1, max: 6, step: 0.05 },
    { key: "heightU", label: "離地高度 u", kind: "range", min: 0, max: 10, step: 0.1 },
    { key: "yawOffsetDeg", label: "水平轉向 °", kind: "range", min: -360, max: 360, step: 1, clearAt: 0 },
    { key: "pitchDeg", label: "仰角 °", kind: "range", min: -90, max: 90, step: 1 },
    { key: "travelU", label: "前進距離 u", kind: "range", min: 0, max: 40, step: 0.1, clearAt: 0 },
    { key: "durationSec", label: "持續 s", kind: "range", min: 0.05, max: 5, step: 0.05 },
