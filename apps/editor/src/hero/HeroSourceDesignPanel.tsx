...
export function HeroSourceDesignPanel({ project, slot, onSlot, onChange }: {
  project: HeroProject; slot: HeroSlot; onSlot(slot: HeroSlot): void; onChange(project: HeroProject): void;
}) {
