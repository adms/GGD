...
// GH#1191：持續引導（channel）同上。
const overrideSchema = zAbilityDef.pick({ rangeTier: true, radiusTier: true, cooldownTier: true, cooldownShape: true, manaCostTier: true, castTimeTier: true, effects: true, recast: true, recastEffects: true, channel: true });
