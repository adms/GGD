...
function manifestOf(doc: unknown): Record<string, unknown> {
  return {
    ...
    // ⭐ 兩個 root 的順序在 ③ 會被反過來 —— 語意投影按 kind/id/revision 排序 ⇒ 同一個 digest。
    selectionRoots: [
      { kind: "ability", id: "hero.q", revision: 2, contentSha256: contentSha256(doc) },
      { kind: "ability", id: "hero.e", revision: 1, contentSha256: contentSha256({ id: "hero.e" }) },
    ],
    changes: [
      {
