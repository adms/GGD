...
COUNTERPART_OWNER = {
    "godie-e007": (AUTHORED, (
        "12 志狼：6 支裡 5 支機制不同 —— 12-01 冷卻/耗魔/階數、12-02 castType、"
        "12-03 整組被動、12-04 castType＋效果（本體是 owner 2026-08-08 的新版規格："
        "self＋範圍傷害＋淨化；變身態仍是 w3x 匯入的 targeted 單體）。"
        "⚠️ 而 12-03 本身還躺在 `common.FORM_TAG_WAIVED` 裡等 owner 裁決（B-4），"
        "⛔ 在他裁決之前把本體鏡射過去等於替他決定了志狼要不要退場。"
    )),
    "godie-e00l": (AUTHORED, (
