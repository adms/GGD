...
A("44-03", "44-03 火車輾過", "targeted", [60, 50, 40, 30], [150, 250, 350, 450], 12,
  "[主動][範圍][AP加成]\n{{cd}}秒冷卻\n消耗MP{{mp}}\n有效半徑：{{radius}}\n\n「我就是正義！」\n使敵方 [詛咒]標記的 [周圍]的敵方部隊受到650/750/850/950+ {{ap}}% [AP]點的劇烈傷害。",
  radiusTier="中",
  ...
  template={'ref': 'tpl-area-strike', 'params': {'castType': 'targeted', 'damageType': 'magic', 'damage': {'damageTierPerRank': ['小', '中', '中', '中'], 'ratios': [{'stat': 'ap', 'coeff': 0.6}]}, 'radius': 6.0, 'radiusTier': '中', 'includeOrigin': True, 'condition': {'kind': 'status', 'subject': 'target', 'statusId': 'curse'}, 'castTimeSec': 1.0}},
  )
