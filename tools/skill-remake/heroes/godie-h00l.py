...
A("60-01", "60-01 旋風斬", "self", [30, 30, 30, 30], [100, 150, 200, 250], 0,
  ...
  template={'ref': 'tpl-area-strike', 'params': {'castType': 'self', 'damageType': 'physical', 'damage': {'damageTierPerRank': ['極小', '極小', '小', '小'], 'ratios': [{'stat': 'ad', 'coeff': 0.5}]}, 'radius': 4.5, 'radiusTier': '小', 'includeOrigin': True, 'onHitTargets': [{'kind': 'knockback', 'distance': 3.0, 'speed': 15.0, 'from': 'caster'}], 'castTimeSec': 0.5}},
  )
...
A("60-03", "60-03 三角神力．勇氣", "self", [0], [0], 0,
  "[被動][強化][普攻時][AP加成]\n\n喚醒勇者體內的三角神力，提高 [智慧]、[敏捷]、[力量] 3/6/9/12點，並且每三下普通攻擊則會額外造成 {{ap}}% [AP]傷害。",
