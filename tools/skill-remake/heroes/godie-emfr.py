...
A("15-01", "15-01 雷神槍「巨神殺手」", "ground", [30, 30, 30, 30], [175, 275, 375, 475], 6.42,
  "[主動][指向][範圍][AP加成]\n{{cd}}秒冷卻\n消耗[MP] {{mp}}\n施法距離：{{range}}\n\n「千之雷是頂級魔法，但我還可以開掛」\n對[前方]一[直線]敵方單位造成 {{dmg}} +{{ap}}% [AP]傷害，附帶麻痺 [緩慢] [移動速度]，持續1秒",
...
A("15-02", "15-02 疾風迅雷", "self", [60, 60, 60, 60], [120, 180, 240, 300], 0,
  "[主動][輔助][變身][普攻時][AP加成]\n{{cd}}秒冷卻\n消耗[MP] {{mp}}\n持續12秒\n\n「質疑魔法、成為魔法、超越魔法」\n獲得 1.2倍 [移動速度] 與 30/60/90/120% [攻擊速度]，普通攻擊附加 30/45/60/75 +{{ap}}% [AP] 雷電傷害。\n([變身]為唯一狀態不可疊加)",
...
A("15-03", "15-03 獄炎煉我", "self", [55, 55, 55, 55], [180, 260, 340, 420], 0,
  "[主動][變身][普攻時][範圍][AP加成]\n{{cd}}秒冷卻\n消耗[MP] {{mp}}\n持續12秒\n\n「問問這砂鍋大的火拳？」\n普通攻擊附加 60/90/120/150 + {{ap}}% [AP] 火焰傷害，每次技能命中都會引發爆炎[燃燒]標記，對[周圍]敵人造成 {{dmg2}} +{{ap2}}% [AP] [範圍]傷害，但[移動速度]減半。\n([變身]為唯一狀態不可疊加)",
...
A("15-04", "15-04 雷天大壯。貳式", "self", [60, 60, 60], [200, 400, 600], 0,
  "[主動][變身][普攻時][AP加成]\n{{cd}}秒冷卻\n消耗[MP] {{mp}}\n持續12秒\n\n「比光更快的是思念，比思念更快的是昨天」\n獲得 2倍 [移動速度]、100/150/200% [攻擊速度]、[攻擊速度上限]提升至10。施放技能後的下一次普通攻擊將釋放雷神一擊，造成 {{dmg}} + {{ap}}% [AP] 雷屬性傷害。\n([變身]為唯一狀態不可疊加)",
  maxRank=3,
