...
A("13-03", "13-03 龍頭戲畫。布陣", "self", [60, 60, 60, 60], [120, 180, 240, 300], 0,
  ...
  template={'ref': 'tpl-area-strike', 'params': {'castType': 'self', 'damageType': 'magic', 'damage': {'damageTierPerRank': ['極小', '極小', '小', '小'], 'ratios': [{'stat': 'ap', 'coeff': 0.6}]}, 'radius': 4.5, 'radiusTier': '小', 'includeOrigin': True, 'castTimeSec': 0.5}},
