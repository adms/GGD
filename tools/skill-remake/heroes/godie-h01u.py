...
A("80-02", "80-02 弒鬼神", "self", [60, 60, 60, 60], [90, 180, 270, 360], 0,
  ...
  template={'ref': 'tpl-area-strike', 'params': {'castType': 'self', 'damageType': 'physical', 'damage': {'damageTier': '極小'}, 'radius': 4.5, 'radiusTier': '小', 'includeOrigin': True, 'onHitTargets': [{'kind': 'knockback', 'distance': 2.5, 'speed': 15.0, 'from': 'caster'}, {'kind': 'applyStatus', 'statusId': 'armor-break', 'duration': 1.0}, {'kind': 'applyBuff', 'modifiers': [{'stat': 'armor', 'op': 'pctAdd', 'value': -1.0}], 'duration': 1.0, 'dispellable': True, 'polarity': 'debuff'}], 'vfx': {'vfxId': 'fx.wave.physical', 'at': 'self'}, 'modelFx': {'shape': 'single', 'preset': 'tpl-locust-travel', 'modelKey': 'imported.crescent', 'clip': 'idle', 'scale': 2.0, 'distance': 4.5}, 'castTimeSec': 0.5}})
