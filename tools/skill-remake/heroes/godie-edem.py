...
A("45-01", "45-01 火遁-豪火龍之術", "ground", [45, 45, 45, 45], [150, 190, 230, 240], 14.67,
  ...
  template={'ref': 'tpl-area-strike', 'params': {'castType': 'ground', 'damageType': 'magic', 'damage': {'damageTierPerRank': ['極小', '極小', '小', '小']}, 'radius': 6.0, 'radiusTier': '中', 'includeOrigin': True, 'onHitTargets': [{'kind': 'applyStatus', 'statusId': 'burn', 'duration': 3.0}, {'kind': 'dot', 'damageType': 'magic', 'amountPerTick': {'flat': 1.0}, 'resourcePct': {'subject': 'target', 'resource': 'health', 'basis': 'current', 'scale': 'ratio', 'perRank': [0.01]}, 'resourcePctPhase': 'onTick', 'intervalSec': 1.0, 'durationSec': 3.0, 'stacking': 'refresh'}], 'castTimeSec': 1.0}},
  )
...
A("45-04", "45-04 哥哥", "self", [0], [0], 0,
  "[被動][技能命中時][身上有某狀態時][範圍][AP加成]\n{{cd}}秒冷卻\n有效半徑：{{radius}}\n\n「我愚蠢的弟弟啊！憎恨吧！」\n當「千鳥」命中帶有[燃燒]標記的敵人時引發忍術「麒麟」雷電大爆炸，對目標[周圍][小範圍]敵人造成{{dmg}}+ {{ap}}% [AP] 傷害。",
