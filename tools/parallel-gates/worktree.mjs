...
/** 把一行寫進**共用的** `.git/info/exclude`（主樹與每一棵 worktree 共用同一份），冪等。 */
function ensureExcluded(repo, line) {
  const f = `${resolve(run(["rev-parse", "--path-format=absolute", "--git-common-dir"], repo, true))}/info/exclude`;
