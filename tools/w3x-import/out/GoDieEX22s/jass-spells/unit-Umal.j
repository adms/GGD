...
// trigger families: ChangeDNA, LightAttack, init_Die, AnKiMagic, BlackBoom, Bleach_Moon, Bleach_Null, Bleach_Null_start, Bleach_Rush, Bleach_Strike, Blood, BloodKill, Blood_Cast, BlueDragonWave, CallPay, ChangeNote, ChoChuFireDro, CombineOne, Cookie, Deal_Elemental_Effect, DeathEye, DeathHeart, DeathTrain, DefEndC, DefMagic, DefStartC, DestWall, Dontkick, EarthBoom, Eat, EightCloud, Elemental_Buff_Attempt, EvilEye, FireBird, FlySwallow, GaiaAngre, Get_Magic_EX, GodWind, HolyShit, HunrThum, ImbaEye, Initiate_Fan_Toss, KaoLight, KniSkill, KnockBack, Legendary_Strike, Light, LightCut, MagicStamp, NO_Eat, NineSlash, Open_World, PayDie, Ptt_Judge, RiderSprint, Riderspell, Set_Charges, ShanWindDragon, SkySlash, Spell_Mark, The_End_ofWorld, The_End_ofWorldStart, ThuBird, TrueBlackBoom, TrueBody, WolfStrike, Wolf_EX, YouDie, animal, chieken, farmer, goagain, godJumpWall, godback, link, lzfs, newlzfs
