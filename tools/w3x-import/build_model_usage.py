...
FAMILIES: list[tuple[str, str, list[str]]] = [
    ...
    ("missile", "飛彈", ["phoenix_missile", "ancientprotectormissile", "fragdriller"]),
    ("groundDust", "地面塵土", ["impaletargetdust", "earthquaketarget"]),
    ("boltStrike", "雷擊", ["monsoonbolttarget"]),
    ("mark", "印記", ["markofchaostarget"]),
    ("mirrorImage", "分身", ["mirrorimagecaster"]),
    ("flamePillar", "火柱", ["flamestriketarget"]),
    ("resurrect", "復活光", ["resurrecttarget", "resurrectcaster", "revivehuman", "awaken"]),
