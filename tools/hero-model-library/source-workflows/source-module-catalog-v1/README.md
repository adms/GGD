...
此聚合器合併 300英雄、Magical Battle Arena、任天堂大亂鬥、KOF 與 J-Stars 的角色級候選片段，產生含輸入 SHA-256 的中央 catalog，並更新五日素材主清單的固定 generated 區塊。逐候選細節保留在三份來源 JSON，不在 `catalog.json` 重複一份。
