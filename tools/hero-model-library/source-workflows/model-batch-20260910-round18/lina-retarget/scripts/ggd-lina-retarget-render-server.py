...
ROOT=Path('/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT');base=ROOT/'GGD-Asset-Library/intake/public-models-20260910';dst=base/'parallel-community-lina-rays-300-retarget';assets={'300-lina':ROOT/'GGD-hero-model-options/content/assets/models/community/df07ee9d9baf46a88033329bcba43d814580521de3d8b4b9a5deb161bd1f0628.glb','rays-retarget':dst/'candidates/lina00-hands-a-300-idle-run-stable-torso.glb'};done=threading.Event();run=dst/'evidence/playback-v2';run.mkdir(exist_ok=True)
