"""Render start, middle and end of each Mario motion in isolated headless Chrome."""
...
chrome='/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';profile=Path(tempfile.mkdtemp(prefix='ggd-ssbu-mario-motion-chrome-'))
