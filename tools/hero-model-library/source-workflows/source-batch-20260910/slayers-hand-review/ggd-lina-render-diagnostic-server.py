...
class Handler(BaseHTTPRequestHandler):
 ...
 def do_GET(self):
  ...
  elif self.path=='/bundle.js':payload=Path('/private/tmp/ggd-lina-diagnostic-bundle.js').read_bytes();mime='text/javascript'
...
for f in ['ggd-lina-render-diagnostic-server.py','ggd-lina-render-diagnostic.mjs']:shutil.copyfile('/private/tmp/'+f,dst/'scripts'/f)
