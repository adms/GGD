"""Render a local FateUBW static candidate skinned GLB in isolated headless Chrome; preserve every run."""
...
profile=Path(tempfile.mkdtemp(prefix='ggd-fateubw-static-chrome-'))
