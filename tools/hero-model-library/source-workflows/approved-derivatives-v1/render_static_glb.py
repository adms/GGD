"""Render one approved derivative in Babylon WebGL and preserve three views."""
...
root=args.repo.resolve();done=threading.Event()
...
chrome='/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';profile=Path(tempfile.mkdtemp(prefix='ggd-approved-derivative-chrome-'))
