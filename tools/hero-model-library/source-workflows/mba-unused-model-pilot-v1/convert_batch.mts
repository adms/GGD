/**
 * Produce a deterministic, six-clip GGD conversion candidate from four
 * identity-confirmed MBA Complete Form 1.60 character bodies.
 *
...
const CONFIG: Config[] = [
  {
    slug: "ruru",
    sourceCharacterId: "mba:Chara01_O",
    characterZh: "露露·傑拉德",
    characterNative: "ルル・ジェラード",
    workZh: "原創（魔法少女武鬥祭）",
    sourceRelativePath: "outputs/game-asset-library-20260907/magical-battle-arena/models/Model/Chara01_O/Ruru.glb",
  },
  {
    slug: "kirara",
    sourceCharacterId: "mba:Chara05",
    characterZh: "星空綺羅羅",
    characterNative: "星空きらら",
    workZh: "原創（魔法少女武鬥祭）",
    sourceRelativePath: "outputs/game-asset-library-20260907/magical-battle-arena/models/Model/Chara05/Kirara.glb",
  },
  {
    slug: "sarara",
    sourceCharacterId: "mba:Chara06",
    characterZh: "星空紗羅羅",
    characterNative: "星空さらら",
    workZh: "原創（魔法少女武鬥祭）",
    sourceRelativePath: "outputs/game-asset-library-20260907/magical-battle-arena/models/Model/Chara06/Sarara.glb",
  },
  {
    slug: "vita",
    sourceCharacterId: "mba:Chara11",
    characterZh: "薇塔",
    characterNative: "ヴィータ",
    workZh: "魔法少女奈葉（魔法少女武鬥祭）",
    sourceRelativePath: "outputs/game-asset-library-20260907/magical-battle-arena/models/Model/Chara11/Vita.glb",
  },
];
...
for (const config of CONFIG) {
  ...
  const selections = Object.fromEntries(Object.entries(CLIP_NAMES).map(([state, name]) => {
  ...
  })) as Record<keyof typeof CLIP_NAMES, number>;
  ...
  const receipt = {
    ...
    transformation: {
      ...
      selectedNativeClips: Object.fromEntries(Object.entries(CLIP_NAMES).map(([state, name]) => [state, {
        name,
    ...
    limitations: [
      "The source identity and GLB body relationship are direct, but the four characters do not have a current GGD hero definition.",
