...
if __name__=='__main__':
    ...
    print(json.dumps({'ok':True,'fighters':16,'nuanmbPaths':435,'transformPaths':411,'bodyCandidatesSizeOnly':128,'romRecordsMetadataOnly':3}))
