#!/usr/bin/env python3
"""Register validated Worldblender c00 batch-2 components in canonical indexes."""
...
CANDIDATES = REPO / "materials/hero-model-library/priority-evidence/ssbu-worldblender-c00-batch2-v1/candidate-rows.json"
...
IDENTITIES = {
    "ssbu-chrom-c00-static-skinned-v1": {"id": "community:ssbu-chrom-c00-standardized-v1", "aliases": ["Chrom", "庫洛姆", "fighter/chrom"], "heroes": []},
    "ssbu-ganondorf-c00-static-skinned-v1": {"id": "community:ssbu-ganondorf-c00-standardized-v1", "aliases": ["Ganondorf", "加儂多夫", "fighter/ganon"], "heroes": []},
    "ssbu-lucina-c00-static-skinned-v1": {"id": "community:ssbu-lucina-c00-standardized-v1", "aliases": ["Lucina", "露琪娜", "fighter/lucina"], "heroes": []},
}
...
def main() -> int:
    ...
    require({row.get("id") for row in candidates} == set(IDENTITIES), "Candidate set differs from the fixed batch-2 roster")
    ...
    for candidate in candidates:
        ...
        for field in ("deliveryEvidence", "validationEvidence", "acceptanceEvidence", "visualEvidence", "webglProofEvidence", "sourceRebuildEvidence", "s3BackupEvidence", "alphaAuditEvidence", "alphaAtlasFinalizationEvidence", "materialBakeEvidence"):
            pin = candidate[field]
        ...
        supplemental_row = {
            ...
            "modelCandidates": [{
                ...
                "alphaAtlasFinalizationEvidence": candidate["alphaAtlasFinalizationEvidence"],
