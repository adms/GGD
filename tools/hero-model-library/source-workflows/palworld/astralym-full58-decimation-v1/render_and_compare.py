"""Render source/candidate at five representative native clips and emit deterministic A/B evidence."""
...
draw.text((810,12),f"Candidate 7,896 tris / {worst['clip']} / {worst['view']}",fill='white')
...
result={'schema':'ggd-palworld-astralym-full58-visual-comparison@1','source':{'path':str(source),'sha256':sha(source)},'candidate':{'path':str(candidate),'sha256':sha(candidate)},
