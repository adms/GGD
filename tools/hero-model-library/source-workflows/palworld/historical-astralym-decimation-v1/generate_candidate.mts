...
const EXPECTED_OUTPUT = "f77cf1ee8dd52cd14e75356f424034f2f8e866d3adafc70642a9f4efed36c2a7";
...
const raw = execFileSync(process.execPath, [worker, SOURCE, output, "--target", "7900", "--emissive-threshold", "192", "--error", "0.02"], { encoding: "utf8" });
...
const receipt = {
  ...
  command: { worker: path.relative(ROOT, worker), target: 7900, emissiveThreshold: 192, errorBound: 0.02, lockBorder: true },
