...
source = root / 'original/jetdragon.fbx'
assert source.is_file()
digest = hashlib.sha256(source.read_bytes()).hexdigest()
parser_dir = Path('/private/tmp/ggd-kof-bpy-arm-venv/lib/python3.13/site-packages/bpy/5.2/scripts/addons_core/io_scene_fbx')
...
analysis = {
    ...
    'crcScope': 'FBX CRC32 computed locally only; all embedded PNG stored chunk CRC values independently verified. Upstream FBX is not an archive and has no provided CRC.',
