    ...
    source = {
        ...
        "limitations": (
            [
                ...
                "Twelve owner-visual-approved GGD VFX documents are on the feature branch; seven reviewed source-name relationships are bound across Q/W/R and five remain unbound reserves. Native Niagara timing, root-specific mesh attribution and full original parity remain open.",
