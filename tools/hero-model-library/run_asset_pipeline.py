...
The runner has no shell, network, AWS, Git mutation, runtime registration, or
deployment capability. Source-specific tools retain their own fail-closed
gates. Check mode may run independent stages concurrently; refresh mode stays
sequential because several generators share the fixed central indexes.
"""
...
def validate_manifest(manifest: dict[str, Any]) -> None:
    ...
    for key in ("remoteLibraryReadAllowed", "networkAccessAllowed", "awsAccessAllowed", "runtimeRegistrationAllowed"):
