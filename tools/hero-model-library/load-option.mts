import { defaultEligible, compareSelection } from './default-policy.mts';
...
export async function loadPreferredLibraryModel(projectId: string, contentRoot = resolve(repo, 'content')) {
  ...
  const option = [...hero.options].filter((o: any) => defaultEligible(projectId, o)).sort((a: any, b: any) => compareSelection(projectId, a, b))[0];
