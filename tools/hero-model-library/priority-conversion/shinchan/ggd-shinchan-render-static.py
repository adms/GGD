...
root=Path('/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/outputs/priority-shinchan-canonical-20260910');out=root/'static-visual-v1';out.mkdir(exist_ok=False);proof=[]
for variant in ['sd2','kstamil']:
 for rig in ['source-rig','canonical-rig']:
  src=root/'conversion-v1'/variant/(rig+'.glb');bpy.ops.wm.read_factory_settings(use_empty=True);bpy.context.preferences.filepaths.use_scripts_auto_execute=False
