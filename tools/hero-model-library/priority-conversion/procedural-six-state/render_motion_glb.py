"""Render front-view start, middle and end frames for each GLB animation."""
...
chrome='/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';profile=Path(tempfile.mkdtemp(prefix='ggd-procedural-motion-chrome-'))
