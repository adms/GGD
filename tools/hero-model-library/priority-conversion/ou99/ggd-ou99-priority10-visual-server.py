...
W=Path('/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT');source=W/'outputs/priority-ou99-standards-v2-20260910';run=W/'outputs/priority-ou99-priority10-visual-audit-20260910';run.mkdir(exist_ok=False);(run/'tools').mkdir();done=threading.Event()
...
class Handler(BaseHTTPRequestHandler):
 ...
 def do_GET(self):
  ...
  elif self.path=='/bundle.js':payload=Path('/private/tmp/ggd-ou99-priority10-visual-bundle.js').read_bytes();mime='text/javascript'
...
for f in ['ggd-ou99-priority10-visual.mjs','ggd-ou99-priority10-visual-server.py']:shutil.copy2('/private/tmp/'+f,run/'tools'/f)
