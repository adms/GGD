...
| attr-03 | Every shipped champion carries a complete `attributes` block, and the eight coefficients live in the combat-env table (not a second config surface) with the shipped WC3 values | attr-248-roster-complete | unit | done |
