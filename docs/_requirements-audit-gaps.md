...
| 我（試玩發現） | 右上角一團白光特效卡住不散 | 📋 建 **#131** | 打擊感稽核也**獨立抓到**（P1 open regression）。P1b sparks wave 修 |
...
| 你 | 每回合合理 3 分鐘後出現火圈加速節奏 | 📋 建 **#132** | `combatMaxSec` 90→~180 + 火圈排程綁「回合長度」單一來源；%HP 真傷 ramp（1%/s 遞增）。連動 #100（打完真的要停）/#46。歸 P3 |
