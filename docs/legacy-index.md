...
**目前共 3347 個檔案**，分佈在 2 個隔離區。

| 隔離區 | 檔數 | 是什麼 |
|---|---:|---|
| [`docs/legacy/`](legacy-index.md#docslegacy) | 2907 | 規格與文件的隔離區（第〇·六守則階梯的第 3–5 層 + 已被取代的同型文件） |
...
| `_overwrites/技能係數公式化計畫_v5_temp_20260902-1412.md` | 技能係數公式化計畫 —— ⭐ **這一份是討論的落點，⛔ 不是票。** 定案之後再拆票（拆法見最後一節）。 | （未逐檔裁決 —— 補進產生器的 CURATED） |
...
| `_overwrites/overwrite_temp_20260902-004049/tools/skill-remake/heroes/godie-e00s.py` | （.py 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-005143/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-014749/tools/skill-remake/heroes/godie-e00s.py` | （.py 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-032250/apps/admin/src/ui/App.tsx` | （.tsx 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-043219/packages/shared/src/content/_probe.test.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-045343/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-045851/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-074207/packages/shared/src/content/import/resolvedAppearance.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-075133/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-081330/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-081346/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-082222/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-082518/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-084718/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-092200/apps/game-server/src/net/mindControlWire.test.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-103907/packages/shared/scripts/probeRefutePassive.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-105455/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-112354/docs/_release/ggd-board.html` | （.html 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
...
| `_overwrites/overwrite_temp_20260902-142507/docs/_execution-batches.md` | GGD 執行批次計畫（Execution Batches） —— ⚠️ 2026-07-30 全面重寫。** 上一版寫著「main = `a6b1609d`，線上 **v0.7.0**」—— | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-143741/scripts/host-deploy.sh` | （.sh 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-143741/scripts/mini-deploy.sh` | （.sh 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-143902/apps/game-server/src/buildHealth.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-143918/apps/game-server/src/buildHealth.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-150618/apps/client/src/vfx/WhirlwindFx.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-150618/apps/client/src/vfx/vfxScriptFields.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-151410/docs/_execution-batches.md` | GGD 執行批次計畫（Execution Batches） —— ⚠️ 2026-07-30 全面重寫。** 上一版寫著「main = `a6b1609d`，線上 **v0.7.0**」—— | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-152535/docs/_execution-batches.md` | GGD 執行批次計畫（Execution Batches） —— ⚠️ 2026-07-30 全面重寫。** 上一版寫著「main = `a6b1609d`，線上 **v0.7.0**」—— | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-154308/apps/client/src/vfx/VfxSystem.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-154308/apps/game-server/src/net/eventFanout.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-161229/content/vfx-scripts/godie-udea.r.json` | （.json 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-164126/packages/shared/src/content/__measure_temp.test.ts` | （.ts 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
| `_overwrites/overwrite_temp_20260902-171237/scripts/content-tree-lock.py` | （.py 檔） | （未逐檔裁決 —— 補進產生器的 CURATED） |
