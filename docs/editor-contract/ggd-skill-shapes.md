...
| 7 | 續效特效＋路徑 | **10** | 2 | tpl-single-strike | 沿用（8 支還沒接） |
| 8 | 持續＋多段 | **6** | 0 | — | ⚠️ 模板已在、**0 支使用**：tpl-proxy-fanout |
| 9 | 等待＋路徑 | **5** | 0 | — | ⚠️ 模板已在、**0 支使用**：tpl-charge-push・tpl-teleport（另有 1 份較不貼合） |
...
| 12 | 等待＋持續＋續效特效＋路徑 | **4** | 0 | — | ⚠️ 模板已在、**0 支使用**：tpl-beam-roll・tpl-line-blast（另有 6 份較不貼合） |
...
| 續效特效 | 11 | 70 | **0** | 特效自己的壽命／掛載／分層（⚠️ 宣稱側很弱，差集不計） |
...
| `tpl-beam-roll` | 翻滾光束（橫放光束砲） | enabled | 14 | **0** | 等待＋續效特效＋路徑 | — |
