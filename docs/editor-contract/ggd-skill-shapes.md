...
|---:|---|---:|---:|---|---|
| 1 | 持續 | **180** | 39 | tpl-buff-self・tpl-proxy-cast | 沿用（141 支還沒接） |
| 2 | （無時序形狀） | **108** | 41 | tpl-instant-blast・tpl-single-strike | ⛔ 逐支確認是**真的沒有**還是**沒實作**（見第 2 節差集） |
| 3 | 路徑 | **25** | 2 | tpl-single-strike | 沿用（23 支還沒接） |
| 4 | 等待＋持續＋續效特效＋多段＋路徑 | **15** | 0 | — | ⚠️ 模板已在、**0 支使用**：tpl-dragon-quake（另有 11 份較不貼合） |
| 5 | 持續＋續效特效 | **14** | 0 | — | ⚠️ 模板已在、**0 支使用**：tpl-proxy-fanout |
...
| 續效特效 | 9 | 63 | **0** | 特效自己的壽命／掛載／分層（⚠️ 宣稱側很弱，差集不計） |
