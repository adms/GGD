...
VFX Forge 每次送審都必須附 `ggd-vfx-visual-audit@1`：完整 runtime
時間軸的採樣格數、最差時間點、粒子／系統峰值、亮區與白底比例及疑似來源。
...
只換擷圖、稽核結果或說明也會令舊裁決失效，必須重新人工檢視；舊 VFX
候選若沒有 GPU 收據，只能由 Forge 重新送審，不得以舊核准補欄位後 Promote。
