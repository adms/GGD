...
產生時間（至分鐘）：2026-09-07T05:18+08:00
...
- GPU 批次：已擷取 47；畫面守衛失敗 0；契約／素材阻塞 0
- 自動根因：LOW_VISUAL_HYGIENE 3、MISSING_VISUAL_BRICK 7、PRESENTATION_ARTIFACT 7
- 自動分工：editor 9、main 8
- 基本視覺安全替代：0 份（只替換 Editor baseline，不改原技能綁定）
- 真機制節點自動補圖：32 份／85 塊（只存在預覽副本，未改 gameplay JSON）
...
|---|---|---|---|---|---|---|
| `godie-u034.passive` 06-00 猜猜拳 | `ability:godie-u034.passive` | preset-stack-plus-advanced-form（on-attack） | not-applicable | captured／3 格／pending | PRESENTATION_ARTIFACT/main | **needs-frame-review** |
...
| `godie-nbbc.e` 08-03 龍鬥氣砲咒文 | `ability:godie-nbbc.e` | advanced-no-code-effect-form | not-applicable | captured／4 格／pending | PRESENTATION_ARTIFACT/editor、MISSING_VISUAL_BRICK/main#solid-beam | **needs-frame-review** |
| `godie-ogrh.r` 09-04 龜派氣功 | `ability:godie-ogrh.r` | preset-stack-plus-advanced-form（beam） | not-applicable | captured／4 格／pending | PRESENTATION_ARTIFACT/editor、MISSING_VISUAL_BRICK/main#solid-beam | **needs-frame-review** |
| `godie-o00x.r` 09-04 龜派氣功 | `ability:godie-ogrh.r` | preset-stack-plus-advanced-form（beam） | not-applicable | captured／4 格／pending | PRESENTATION_ARTIFACT/editor、MISSING_VISUAL_BRICK/main#solid-beam | **needs-frame-review** |
| `godie-e002.ex` 20-002 解放.約束勝利劍MAX | `chain:avalon-ex` | preset-stack-plus-advanced-form（reactive） | skill-forge-effect-graph | captured／10 格／pending | PRESENTATION_ARTIFACT/editor、MISSING_VISUAL_BRICK/main#solid-beam | **needs-frame-review** |
...
| `godie-e00l.ex` 20-002 解放.約束勝利劍MAX | `chain:avalon-ex` | preset-stack-plus-advanced-form（reactive） | skill-forge-effect-graph | captured／10 格／pending | PRESENTATION_ARTIFACT/editor、MISSING_VISUAL_BRICK/main#solid-beam | **needs-frame-review** |
| `godie-hvsh.r` 48-04 騎英之疆繩 | `ability:godie-hvsh.r` | template-product | not-applicable | captured／4 格／pending | PRESENTATION_ARTIFACT/editor、MISSING_VISUAL_BRICK/main#solid-beam | **needs-frame-review** |
...
| `godie-o00k.e` 86-03 神鳴 | `ability:godie-o00k.e` | template-product（instant-area） | not-applicable | captured／3 格／pending | LOW_VISUAL_HYGIENE/editor | **needs-frame-review** |
...
| `godie-h01u.r` 80-04 赤兔咆哮 | `ability:godie-h01u.r` | advanced-no-code-effect-form | skill-forge-effect-graph；script 時間軸：onBasicAttack、onDamageTaken | captured／8 格／pending | LOW_VISUAL_HYGIENE/editor | **needs-frame-review** |
...
| `godie-hapm.q` 52-01 狂戰士之怒 | `ability:godie-hapm.q` | advanced-no-code-effect-form | skill-forge-effect-graph；script 時間軸：onDamageTaken | captured／2 格／pending | LOW_VISUAL_HYGIENE/editor | **needs-frame-review** |
