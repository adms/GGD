...
產生時間（至分鐘）：2026-09-04T06:27+08:00
...
- 自動分工：main 7
- 基本視覺安全替代：1 份（只替換 Editor baseline，不改原技能綁定）
...
|---|---|---|---|---|---|---|
| `godie-hart.r` 01-04 超究武神霸斬 | `ability:godie-hart.r` | preset-stack-plus-advanced-form（combo） | not-applicable | captured／8 格／pending | MISSING_VISUAL_BRICK/main | **needs-frame-review** |
...
| `godie-nbbc.e` 08-03 龍鬥氣砲咒文 | `ability:godie-nbbc.e` | advanced-no-code-effect-form | not-applicable | captured／4 格／pending | MISSING_VISUAL_BRICK/main | **needs-frame-review** |
| `godie-ogrh.r` 09-04 龜派氣功 | `ability:godie-ogrh.r` | preset-stack-plus-advanced-form（beam） | not-applicable | captured／4 格／pending | MISSING_VISUAL_BRICK/main | **needs-frame-review** |
| `godie-o00x.r` 09-04 龜派氣功 | `ability:godie-ogrh.r` | preset-stack-plus-advanced-form（beam） | not-applicable | captured／4 格／pending | MISSING_VISUAL_BRICK/main | **needs-frame-review** |
...
| `godie-hvsh.r` 48-04 騎英之疆繩 | `ability:godie-hvsh.r` | template-product | not-applicable | captured／4 格／pending | MISSING_VISUAL_BRICK/main | **needs-frame-review** |
| `godie-hvwd.e` 02-03 魂飛魄散 | `ability:godie-hvwd.e` | template-product（single-burst）；安全替代 `fx.w3x.particle.heronarutos4effect.p00` → `fx.prim.arcane.pulse` | not-applicable | captured／2 格／pending | — | **needs-frame-review** |
...
| `godie-hjai.w` 04-02 炸彈陣 | `ability:godie-hjai.w` | template-product（periodic-field） | not-applicable | captured／7 格／pending | — | **needs-frame-review** |
