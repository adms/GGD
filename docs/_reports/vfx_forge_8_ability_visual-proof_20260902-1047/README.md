# VFX Forge 八招候選畫面驗收（2026-09-02T02:45:50.950Z）
...
|---|---|---|---:|---|
| 04-03 莉娜 · 龍破斬 | 投射後一段距離爆炸 | `1b3884cb152b`／`5ecf922c0bb8` | 6.5/10 | 待 Owner 於後台 pass/fail |
| 04-04 莉娜 · 神滅斬 | dash 後斬擊 | `a2c14f8d7112`／`84d1ad3423ab` | 9.5/10 | 待 Owner 於後台 pass/fail |
| 01-04 克勞德 · 超究武神霸斬 | 動畫連斬＋黃藍直立光束砲 | `fb3b8971c3ec`／`2ee7b6cad9f0` | 8.5/10 | 待 Owner 於後台 pass/fail |
| 08-04 小呆 · 阿邦快速劍X | A 衝擊波＋B dash 斬擊 | `d58ce9d2c969`／`61eb7661c7b4` | 8/10 | 待 Owner 於後台 pass/fail |
| 08-03 小呆 · 龍鬥氣砲咒文 | 橫向藍色氣功砲 | `9986aee4d190`／`63b8b6415031` | 9/10 | 待 Owner 於後台 pass/fail |
| 09-04 悟空 · 龜派氣功 | 橫向橘色氣功砲 | `e1dacd1cafeb`／`1b1978948acf` | 8.5/10 | 待 Owner 於後台 pass/fail |
| 20-002 Saber · 理想鄉 EX | 反擊＋動畫連斬＋氣功砲 | `4c03337bb639`／`628dd3876c22` | 8.5/10 | 待 Owner 於後台 pass/fail |
| 48-04 Rider · 騎英之手綱 | dash＋橫向藍色氣功砲 | `10f5cb288016`／`c4c329d0b429` | 9/10 | 待 Owner 於後台 pass/fail |
...
- 候選：`1b3884cb152b`；審查材料：`5ecf922c0bb8`；base：`18ca2813b877`
- GPU 完整時間軸：36 格；衛生分流 6.5/10；最差 1.067 秒；粒子峰值 149／系統 45
...
- 候選：`a2c14f8d7112`；審查材料：`84d1ad3423ab`；base：`bfcc5a3f6137`
...
- 候選：`fb3b8971c3ec`；審查材料：`2ee7b6cad9f0`；base：`5d4246fce987`
- GPU 完整時間軸：87 格；衛生分流 8.5/10；最差 4.600 秒；粒子峰值 111／系統 33
...
- 候選：`d58ce9d2c969`；審查材料：`61eb7661c7b4`；base：`12f94b560627`
- GPU 完整時間軸：35 格；衛生分流 8/10；最差 0.867 秒；粒子峰值 72／系統 15
...
- 候選：`9986aee4d190`；審查材料：`63b8b6415031`；base：`dec6664f123e`
...
- 候選：`e1dacd1cafeb`；審查材料：`1b1978948acf`；base：`1041cd57986c`
- GPU 完整時間軸：34 格；衛生分流 8.5/10；最差 0.867 秒；粒子峰值 82／系統 14
...
- 候選：`4c03337bb639`；審查材料：`628dd3876c22`；base：`2c4e6a17fa76`
- GPU 完整時間軸：39 格；衛生分流 8.5/10；最差 0.000 秒；粒子峰值 268／系統 69
...
- 候選：`10f5cb288016`；審查材料：`c4c329d0b429`；base：`9e82d17670c6`
- GPU 完整時間軸：39 格；衛生分流 9/10；最差 1.467 秒；粒子峰值 109／系統 22
