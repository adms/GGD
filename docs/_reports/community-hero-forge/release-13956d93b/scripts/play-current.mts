...
import { readTargetProfileFacts } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/apps/editor/src/export-center/exportPolicy";
import { ContentLoader } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/content/loader";
import { FsContentSource } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/content/node/FsContentSource";
import { OverlayContentSource } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/content/overlay";
import { registerAll } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/content/registries";
import { registerSkeletonContent } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/sim/content/skeleton";
import { buildCommunityRoomContent, captureCommunityContentBase, verifyCommunityRoomManifest } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/content/communityRoom";
import { unpackEventBatch, type EventMessage } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/protocol/messages";
import { Abilities, Champions } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/sim/content/registry";
import { withRegistryContext } from "/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/packages/shared/src/sim/content/registryContext";
...
const { Client } = requireClient("colyseus.js") as typeof import("/Users/Takuro/Dropbox/我的 Mac (Moriya.local)/Documents/ABxVFX_EDIT/GGD-community-hero-forge-s3/apps/client/node_modules/colyseus.js");
...
const audit = JSON.parse(readFileSync('/private/tmp/ggd-model-upload-acceptance/release-13956d93b/publication-37-attempt2/report.json','utf8'));
assert.equal(audit.heroCount,37);
const publications = audit.rows.map((r: any) => ({workId:r.workId,submissionId:r.submissionId,packageDigest:r.packageDigest,snapshotDigest:r.snapshotDigest,name:r.name}));
...
try {
 ...
 assert.equal(verifyCommunityRoomManifest(readyB.communityContent).digest, manifest.digest);
  const loaded = await new ContentLoader(new OverlayContentSource(new FsContentSource(process.env.CONTENT_DIR ?? resolve(root, "content")), await json("/content-overlay/bundle"))).load({ policy: "fail-closed" });
