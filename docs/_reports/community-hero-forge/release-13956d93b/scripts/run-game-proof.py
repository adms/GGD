...
await_report('submission-37/report.json')
run('publish-batch.mts','publish-batch-attempt2.log')
await_report('publication-37-attempt2/report.json')
run('play-current.mts','play-current.log',{'GGD_LOCAL_PROOF_REPORT':str(root/'evidence/match.json')})
