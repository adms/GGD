...
- 本頁影格與下表是 AI 預審證據，不是人工裁決帳本。
- 舊欄位 `通過／部分通過` 已改列為「AI 初判」；八招目前全部是 `fixture-pending`。
...
| # | 技能與原作參考 | 真實班表／檢查點 | 視覺結果 | AI 初判（非 verdict） |
|---:|---|---|---|---|
...
| 8 | Rider 48-04 騎英之手綱 · [YouTube @446s](https://youtu.be/KwAlIYfmV48?t=446) | 1.000s 吟唱完成；1.08–1.78s | Rider 替身沿 toTarget 高速移動，並有藍色寬砲與白色核心；dash 身體在砲光中仍稍難讀 | **待人工審查** |
