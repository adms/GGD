# VFX Forge 八招候選畫面驗收（2026-09-02T02:13:14.787Z）
...
|---|---|---|---:|---|
| 04-03 莉娜 · 龍破斬 | 投射後一段距離爆炸 | `1b3884cb152b` | 6.5/10 | 待 Owner 於後台 pass/fail |
| 04-04 莉娜 · 神滅斬 | dash 後斬擊 | `a2c14f8d7112` | 9/10 | 待 Owner 於後台 pass/fail |
| 01-04 克勞德 · 超究武神霸斬 | 動畫連斬＋黃藍直立光束砲 | `fb3b8971c3ec` | 0/10 | 待 Owner 於後台 pass/fail |
| 08-04 小呆 · 阿邦快速劍X | A 衝擊波＋B dash 斬擊 | `d58ce9d2c969` | 8/10 | 待 Owner 於後台 pass/fail |
| 08-03 小呆 · 龍鬥氣砲咒文 | 橫向藍色氣功砲 | `9986aee4d190` | 8.5/10 | 待 Owner 於後台 pass/fail |
| 09-04 悟空 · 龜派氣功 | 橫向橘色氣功砲 | `e1dacd1cafeb` | 8/10 | 待 Owner 於後台 pass/fail |
| 20-002 Saber · 理想鄉 EX | 反擊＋動畫連斬＋氣功砲 | `4c03337bb639` | 2/10 | 待 Owner 於後台 pass/fail |
| 48-04 Rider · 騎英之手綱 | dash＋橫向藍色氣功砲 | `10f5cb288016` | 6.5/10 | 待 Owner 於後台 pass/fail |
...
- 候選：`1b3884cb152b`（base `18ca2813b877`），自動清晰度 6.5/10
...
- 候選：`a2c14f8d7112`（base `bfcc5a3f6137`），自動清晰度 9/10
...
- 候選：`fb3b8971c3ec`（base `5d4246fce987`），自動清晰度 0/10
...
- 候選：`d58ce9d2c969`（base `12f94b560627`），自動清晰度 8/10
...
- 候選：`9986aee4d190`（base `dec6664f123e`），自動清晰度 8.5/10
...
- 候選：`e1dacd1cafeb`（base `1041cd57986c`），自動清晰度 8/10
...
- 候選：`4c03337bb639`（base `2c4e6a17fa76`），自動清晰度 2/10
...
- 候選：`10f5cb288016`（base `9e82d17670c6`），自動清晰度 6.5/10
