# MDL → 技能特效家族 對照（2026-08-26）

> join：OBJECTS.json（461 單位）× census sites（644 生成點）× JASS 行為卡 × 出貨名冊。
> hosted 版（含狀態色）：claude.ai artifact「MDL 特效家族總表」。

## TornadoElemental.mdl（9 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u00A | 蒸汽球 |  | 0 | 零生成點（w3a 通道待查） |
| o01H | 螺旋劍 | 4.0 | 1 | 〔trigger spiralAttack〕（未對上） |
| e00Y | 雷電風暴 | 3.0 | 1 | 15-03 雷電風暴→godie-emfr.e |
| o01P | 天翔龍閃 | 3.0 | 3 | 47-04 天翔龍閃（未對上）；78-03 廬山昇龍破→godie-u00v.e；〔trigger init_Die〕（未對上） |
| h01S | 三千世界特效單位(龍捲風) | 2.0 | 1 | 11-04 三千世界→godie-u01u.r,godie-udre.r |
| u00Z | starbreaker | 2.0 | 0 | 零生成點（w3a 通道待查） |
| h027 | 三檔旋風 | 2.0 | 1 | 〔trigger Luf_Three_Effect〕（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o00E | 打雷 | 10.0 | 10 | 25-04 ChangeDNA→godie-u00l.r,godie-umal.r；32-03 閃光龍牙（未對上）；45-02 千鳥流→godie-edem.w；86-04 打雷絕招→godie-o00k.r；〔trigger Fifty_Sky_Effect〕（未對上）；〔trigger Open_Skill_of_Pikachu_Copy〕（未對上）；〔trigger Open_Skill_of_Pikachu〕（未對上）；十萬伏特放電 (LightningSpread, 不在 HERO_NUMBERS — 疑 EX/隱藏技)（未對上） |
| h00Q | 雷斬刀 | 10.0 | 0 | 零生成點（w3a 通道待查） |
| o00G | avalon | 6.0 | 4 | 20-02 感知能力→godie-e002.q,godie-e00l.q；20-04 Avalon-永恆的理想鄉→godie-e002.r,godie-e00l.r；65-002 永恆的愚蠢鄉 (EX)→godie-udea.ex；〔trigger Open_Skill_of_Saber〕（未對上） |
| n00N | 閃電 | 2.0 | 2 | 34-04 奧義˙蒼龍破→godie-osam.r；45-03 千鳥→godie-edem.e |
| n011 | 涅吉雷之斧 | 5.0 | 0 | 零生成點（w3a 通道待查） |
| o02M | 疾風怒雷 | 6.0 | 1 | 〔trigger LigtingHamm〕（未對上） |
...
| o00H | 磁力球 |  | 1 | 05-03 及喀爾度（未對上） |

## ReviveHuman.mdl（4 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h007 | 特效龜派 | 1.25 | 3 | 03-04 全彈發射（未對上）；90-04 陽光烈焰→godie-h02r.r,godie-hgam.r；〔trigger Turtle_Power〕（未對上） |
| h00S | 勝利劍 | 0.2 | 3 | 20-03 約束與勝利之劍 (Excalibur)→godie-e002.e,godie-e00l.e；20-04 EX (Avalon EX / ExcaliburMAX)→godie-e002.r,godie-e00l.r；〔trigger Open_Skill_of_Saber〕（未對上） |
| h01V | 81-03天神烈破 | 3.0 | 1 | 81-03 Divine Buster Extention（未對上） |
| n00V | 星光炸裂 delete | 2.0 | 0 | 零生成點（w3a 通道待查） |

## TomeOfRetrainingCaster.mdl（4 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h00N | 特效全彈 | 1.25 | 1 | 03-04 全彈發射（未對上） |
| o00R | 王者之笛 | 6.0 | 1 | 物品英雄之笛 (HeroCome)（未對上） |
| h025 | 騎英之守綱(特效) | 4.0 | 2 | 48-00 石化之眼→godie-hvsh.passive；48-04 騎英之疆繩→godie-hvsh.r |
| h02I | 騎英之守綱(特效3) | 5.0 | 1 | 〔trigger Initate_Crazy〕（未對上） |
...
| h00Z | 九頭龍閃 | 2.0 | 1 | 47-03 九頭龍閃（未對上） |
| o019 | 動地剁 | 2.0 | 1 | 〔trigger DragonTigerReady〕（未對上） |
| o01U | 接技特效(動地跺) | 5.0 | 1 | 〔trigger Hell_Timer8〕（未對上） |

## ForgottenOneTent.mdl（4 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u02S | 黑洞聖杯泥 | 2.0 | 1 | 疑似 69-03 (黑洞/InSpace; A0FK 不在 HERO_NUMBERS 69 技能表)（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| oshm | None | 1.4 | 5 | (EX被動: 攻擊時嗚鎖打, 借用A0SR=22-003 嗚鎖打)（未對上）；22-00 嗚鎖打!→godie-e001.passive,godie-e00n.passive；22-003 嗚鎖打 (EX 夜間追擊)（未對上）；89-03 憤怒的胸毛→godie-h02k.e；89-04 憤怒的簡諧運動→godie-h02k.r |
| h019 | 金鋼狼 | 1.6 | 1 | 31-01 迴旋爪擊（未對上） |
| o031 | 安云加速 | 1.4 | 0 | 零生成點（w3a 通道待查） |

## ANsaTarget.mdl（3 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o002 | 死亡筆記本 |  | 3 | 44-03 火車輾過→godie-emns.e；44-04 心臟麻痺→godie-emns.r |
| o00B | 天地魔鬥 |  | 1 | HolyShit 環狀衝擊 (A01W 不在 HERO_NUMBERS 37 清單)（未對上） |
| o000 | 復仇之袍 |  | 0 | 零生成點（w3a 通道待查） |

## Roots.mdl（3 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o00A | 魔界植物 |  | 3 | 18-02 寄生種子→godie-n00p.w,godie-nsjs.w；18-03 妖狐變化 (妖狐型態反擊, 與 A0P7 等級連動)→godie-n00p.e,godie-nsjs.e；億年樹EX/超級老樹 (A00O 未列於 HERO_NUMBERS 18 技能表)（未對上） |
...
| o006 | 雷切 | 3.5 | 2 | 23-04 雷焰聖劍（未對上）；45-03 千鳥→godie-edem.e |
| o01F | 雷光劍(落雷) | 2.0 | 1 | 〔trigger Light_Fight〕（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h01Y | 奈葉魔法陣 |  | 2 | 81-03 Divine Buster Extention（未對上）；81-04 Starlight Breaker Plus（未對上） |
| h01Z | 奈葉魔法陣（放大） | 2.0 | 2 | 81-03 Divine Buster Extention（未對上）；81-04 Starlight Breaker Plus（未對上） |
| h02D | 騎英魔法陣 | 1.5 | 1 | 〔trigger Initate_Crazy〕（未對上） |

## UnholyAura.mdl（3 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o026 | 23魔法陣 | 2.0 | 1 | 23-01 電離光槍 - 繁星飛躍（未對上） |
| o027 | 23魔法陣2 | 3.0 | 1 | 23-04 雷焰聖劍（未對上） |
| u02R | 黃色魔法陣 | 3.0 | 1 | 23-03 雷牙一閃˙雷牙烈霸（未對上） |
...
| h031 | 鄉民 | 1.5 | 1 | 〔trigger Ptt_Judge〕（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| osp1 | 教室 | 3.0 | 1 | 小考 (quiz, A0WK 不在 HERO_NUMBERS 93 清單)（未對上） |
| o01N | 重力之球 | 2.5 | 3 | 34-002 冥道殘月破 (EX)→godie-osam.ex；〔trigger AKT_3〕（未對上）；〔trigger GravityBall〕（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u005 | 痴漢戰士 |  | 3 | 〔trigger GoDie_Center_SpawnF〕（未對上）；〔trigger GoDie_North_SpawnF〕（未對上）；〔trigger GoDie_South_SpawnF〕（未對上） |
| u01I | 痴漢戰士 |  | 3 | 〔trigger GoDie_Center_SpawnF〕（未對上）；〔trigger GoDie_North_SpawnF〕（未對上）；〔trigger GoDie_South_SpawnF〕（未對上） |

## KonYui.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u006 | 愛的戰士 |  | 3 | 〔trigger Love_Center_SpawnF〕（未對上）；〔trigger Love_North_SpawnF〕（未對上）；〔trigger Love_South_SpawnF〕（未對上） |
| u01H | 愛的戰士 |  | 3 | 〔trigger Love_Center_SpawnF〕（未對上）；〔trigger Love_North_SpawnF〕（未對上）；〔trigger Love_South_SpawnF〕（未對上） |

## Ritsu.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u007 | 科科鼓手 | 1.2 | 3 | 〔trigger GoDie_Center_SpawnM〕（未對上）；〔trigger GoDie_North_SpawnM〕（未對上）；〔trigger GoDie_South_SpawnM〕（未對上） |
| u01K | 科科鼓手 | 1.2 | 3 | 〔trigger GoDie_Center_SpawnM〕（未對上）；〔trigger GoDie_North_SpawnM〕（未對上）；〔trigger GoDie_South_SpawnM〕（未對上） |

## AzuNyan.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u008 | 害羞吉他手 | 1.2 | 3 | 〔trigger Love_Center_SpawnM〕（未對上）；〔trigger Love_North_SpawnM〕（未對上）；〔trigger Love_South_SpawnM〕（未對上） |
| u01J | 害羞吉他手 | 1.2 | 3 | 〔trigger Love_Center_SpawnM〕（未對上）；〔trigger Love_North_SpawnM〕（未對上）；〔trigger Love_South_SpawnM〕（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h00K | Holy Strike Missile |  | 2 | 16-02 阿彌陀流真空佛陀斬 (comment: 真空佛陀斬)（未對上）；〔trigger Soul_Shock〕（未對上） |
| h02H | 騎英之守綱(特效2) | 3.0 | 1 | 〔trigger Initate_Crazy〕（未對上） |

## FarseerMissile.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| e00H | Chain Bolt | 2.0 | 0 | 零生成點（w3a 通道待查） |
| o01T | 接技特效兼隱藏施法 | 3.5 | 3 | 〔trigger Hell_Rock_Move〕（未對上）；〔trigger Hell_Timer2〕（未對上）；〔trigger Hell_Timer4〕（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o00P | 寒冰 | 1.8 | 1 | 〔trigger Run_Effect〕（未對上） |
| u013 | 世界終結 | 3.0 | 2 | 〔trigger The_End_ofWorldCasting_EX〕（未對上）；〔trigger The_End_ofWorldCasting〕（未對上） |

## PossessionCaster.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o00S | 黑洞 | 10.0 | 1 | 疑似 69-03 (黑洞/InSpace; A0FK 不在 HERO_NUMBERS 69 技能表)（未對上） |
| o029 | 毀滅彈 | 10.0 | 1 | 28-04 破滅能量彈→godie-huth.r |

## NetherStrike.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h00X | 勝利劍 黑化 | 0.2 | 2 | 20-03 約束與勝利之劍 (Excalibur)→godie-e002.e,godie-e00l.e；〔trigger Open_Skill_of_DarkSaber〕（未對上） |
...
| o01R | 月牙天衝(虛化) | 2.0 | 1 | 〔trigger Bleach_Moon〕（未對上） |

## DuneWorm.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o010 | 黑龍波龍形 |  | 1 | 〔trigger Open_Skill_of_Hehi〕（未對上） |
| o01V | 黑龍波龍形2 | 5.0 | 2 | 38-04 黑龍波吸收→godie-u010.r,godie-uvng.r；〔trigger Open_Skill_of_Hehi〕（未對上） |

## DiabloCar.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u002 | 兄貴戰士 |  | 3 | 〔trigger AICallHelp〕（未對上）；〔trigger GoDie_CenterFi〕（未對上） |
| u02U | 援軍戰士 |  | 1 | 〔trigger Wood_Warrior〕（未對上） |

## ParasiteMissile.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h000 | 龍氣 | 2.0 | 1 | 12-04 龍氣爆發→godie-e007.r,godie-ewar.r |
| h02X | 太陽光束 | 7.0 | 1 | 〔trigger SunFire_pre〕（未對上） |
...
| u018 | 安云衝刺 | 2.0 | 4 | 16-03 無無明亦無 (comment: 無無明亦無)（未對上）；19-03 瞬切百殺（未對上）；19-04 幻影暗殺（未對上）；20-04 EX (Avalon EX / ExcaliburMAX)→godie-e002.r,godie-e00l.r |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o01G | 東風檜扇南風末廣 |  | 2 | 〔trigger Wind_Effect〕（未對上） |
| o01L | 召喚顯示特效 | 5.0 | 1 | 〔trigger AKT_Effect〕（未對上） |

## VillagerWoman.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h01G | 和香 | 1.0 | 1 | 〔trigger AKT_start〕（未對上） |
| h01Q | 佩 |  | 1 | 35-00 召喚佩（未對上） |

## DoomDeath.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o01M | 火焰爆炸 | 8.0 | 2 | 〔trigger AKT_2〕（未對上）；〔trigger BR_Law〕（未對上） |
| o021 | 豪火龍之術-末日 | 2.0 | 1 | 45-01 火遁-豪火龍之術→godie-edem.q |

## OrbOfDeathMissile.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| u00U | Rider衝刺 | 7.0 | 2 | 〔trigger Bleach_Moon_Effect〕（未對上）；〔trigger Crazy_Movement〕（未對上） |
| u00X | 胖虎搖滾 | 10.0 | 1 | 〔trigger Hell_Timer9〕（未對上） |

## BronzeDragon.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h01K | 金色巨龍 | 4.0 | 6 | 〔trigger GoldDrgan_Effect〕（未對上）；金龍吞噬 (EX, 無NN編號)（未對上） |
| o01Y | 龍拳 | 4.0 | 0 | 零生成點（w3a 通道待查） |

## NeutralizationMissile.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o01Q | 月牙天衝 | 10.0 | 1 | 〔trigger Bleach_Moon〕（未對上） |
...
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o02J | 涅吉雷之投擲 | 4.0 | 1 | 82-03 雷之投擲（未對上） |
| o02K | 戰鬥涅吉巨神殺 | 8.0 | 1 | 82-00-01 魔法射手-光箭（未對上） |

## LightningTornado.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h00R | 神鳴 |  | 0 | 零生成點（w3a 通道待查） |
| o02U | 雷光投射 | 0.5 | 1 | 〔trigger Light_sword〕（未對上） |

## TidalGuardian.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| h00Y | 老二 | 2.0 | 0 | 零生成點（w3a 通道待查） |
| u01P | 死亡老二映像 | 1.5 | 1 | 〔trigger DMC_Dead〕（未對上） |

## AquaSpikeVersion2.mdl（2 dummies）
| rawcode | dummy | scale | 生成點 | 技能 → GGD |
|---|---|---:|---:|---|
| o02Y | 涅吉風花武裝解除 | 2.0 | 1 | 15-002 風花-武裝解除 (EX)→godie-emfr.ex |
| h032 | 龍氣2 GodEye | 2.0 | 2 | 02-002 神通眼 (EX)→godie-hvwd.ex；02-04 百鬼夜行→godie-hvwd.r |
