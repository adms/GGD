...
import {wholePlanProbes} from './whole-plan-probes.mts';
...
const checkerFiles=['ir-v4.mts','ir4-compiler.mts','native-mechanism-actions.mts','whole-plan-seeds-v1.mts','whole-plan-probes.mts','probe-harness.mts'];
const manifest={schema:'ggd-whole-mechanism-plan-candidates@1',createdAt:new Date().toISOString(),heroes:rows.length,slots:12,
  ...
  fullHeroQualified:0,modelInference:false,modelTraining:false,liveEngineEdited:false};
