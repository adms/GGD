...
export function prepare(previousRun,root){
 ...
 const code=['r7-prepare.mjs','r7-run.mjs','r7-PRETRAIN_REVIEW.md','r6-train.py','r6-verify.mjs','r6-score.mjs','worker.py'].map(n=>path.join(dir,n));
...
export function assertPriorFinished(root,runtime){
 ...
 for(const [file,status] of [['run-state.json','complete-research-only'],['post-v1/state.json','complete-research-evidence'],['manual-entry-v3/state.json','complete-research-evidence'],['finish-v1/state.json','complete-research-evidence']]){
