/** Zero-penalty three-arm post-selection regressions, all already used in R6.
...
async function main(){
 ...
 const datasets=[
  {name:'source-63-regression',where:fresh,fresh:false},
