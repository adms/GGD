...
import {collect,render} from './r7-final-report.mjs';
...
async function main(root,runtime){
 ...
 const pinPaths=[self,path.join(path.dirname(self),'r7-final-report.mjs'),policyPath,path.join(root,'dataset-manifest.json')];
