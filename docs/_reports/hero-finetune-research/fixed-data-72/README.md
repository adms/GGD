...
```sh
python3 tools/editor-acceptance/hero-finetune-archive.py verify /absolute/new/hydrated-delivery/fixed-data-72/bundle
python3 tools/editor-acceptance/hero-finetune-archive.py extract /absolute/new/hydrated-delivery/fixed-data-72/bundle --destination /absolute/new/research-workspace
```
