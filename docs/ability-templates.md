...
| [直線分段掃擊](#直線分段掃擊) | 3 | 4.7 | 單幀內沿直線鋪滿 N 段 AoE 的瞬間掃擊。 |
...
| 技能 | 英雄 | 落差分 | 行為幾何 | 行為時序 | 位移語意 | 證據 |
|---|---|---|---|---|---|---|
| 09-04 龜派氣功 | 超級賽亞人 - 悟空(R); 賽亞人 - 悟空(R) | 5 | 6 段 × 200u 沿施法方向, 每段 400 AoE; 樹木 400r 摧毀; 512r 英雄鏡頭震動; 口徑特效在 | instant (單幀雙 loop), 尾端 sleep 2s 清鏡頭 | 無 (傷害段一次性鋪滿直線) | war3map.j:31804-31808 (A03S cond), 31916 |
...
| 90-04 陽光烈焰 | 種子神奇寶貝 - 妙蛙花(R); 種子神奇寶貝 - 妙蛙種子(R) | 5 | 10段×100u 朝目標方向, 每段 AoE 280 (樹木350); 傷害 300×lvl+2×(STR+AGI+IN | instant 單幀 (pre: 引導1.0s 蓄能視覺 h02X; 光束2s後 | 無施法者位移; 傷害線瞬間鋪滿 | j:26699-26727 (pre channel dummy), j:267 |
