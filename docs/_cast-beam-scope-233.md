...
| 0.8 s | 13 | 339 ms | `reactable` | 出現 + **下墜倒數**，光點落地＝技能生效 |
| 0.7 s | 29 | 253 ms | `reactable` | 出現 + **下墜倒數**，光點落地＝技能生效 |
| 0.6 s | 52 | 167 ms | `reactable` | 出現 + **下墜倒數**，光點落地＝技能生效 |
| 0.5 s | 95 | 81 ms | `marginal` | 出現 + **下墜倒數**，光點落地＝技能生效 |
| 0.4 s | 195 | -5 ms | `notice` | 出現，但**不畫下墜倒數**（沒有可閃的窗口，倒數就是騙人） |
| 0.3 s | 195 | -91 ms | `notice` | 出現，但**不畫下墜倒數**（沒有可閃的窗口，倒數就是騙人） |
| 瞬發 | 115 | — | `instant` | **不出現**（沒有施法窗口可以預告） |
