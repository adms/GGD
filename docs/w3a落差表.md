...
| 220 | `radius` | `ggd-absent` | `AOww` | 90-01 飛葉快刀 | `godie-h02r.q` | 225.0 | None |
...
| 240 | `radius` | `ggd-absent` | `A0DT` | 53-04 暴爆咒 | `godie-o00l.r` | 400.0 | None |
| 241 | `radius` | `ggd-absent` | `A0UE` | 53-04 暴爆咒 | `godie-o00l.r` | 10.0 | None |
| 242 | `radius` | `ggd-absent` | `A0SI` | 09-002a 悟空指令靈氣 | `godie-o00x.ex` | 10.0 | None |
| 243 | `radius` | `ggd-absent` | `A082` | 09-01 界王拳 | `godie-o00x.q` | 50.0 | None |
| 244 | `radius` | `ggd-absent` | `A03S` | 09-04 龜派氣功 | `godie-o00x.r` | 400.0 | None |
| 245 | `radius` | `ggd-absent` | `A0SL` | 58-002 打雷絕招 | `godie-o02l.ex` | 1800.0 | None |
| 246 | `radius` | `ggd-absent` | `A11B` | 99-03 初音未來的消失 | `godie-o02p.e` | 0.0 | None |
| 247 | `radius` | `ggd-absent` | `A10I` | 30-002 EX變態針刺 | `godie-o030.ex` | 100.0 | None |
| 248 | `radius` | `ggd-absent` | `A01P` | 30-04 電車之狼衝擊 | `godie-o030.r` | 350.0 | None |
| 249 | `radius` | `ggd-absent` | `ANdh` | 30-02 酒精灌腸 | `godie-o030.w` | 600.0 | None |
| 250 | `radius` | `ggd-absent` | `ANmo` | 72-01洗刷刷 | `godie-ogld.q` | 350.0 | None |
| 251 | `radius` | `ggd-absent` | `ACdr` | 34-00 靈魂吞噬 | `godie-osam.passive` | 350.0 | None |
| 252 | `radius` | `ggd-absent` | `A034` | 34-01 風華之爪 | `godie-osam.q` | 260.0 | None |
| 253 | `radius` | `ggd-absent` | `A0FP` | 34-04 奧義˙蒼龍破 | `godie-osam.r` | 350.0 | None |
| 254 | `radius` | `ggd-absent` | `A0DO` | 39-03 無名神風流-蛟龍 | `godie-u00h.e` | 1.0 | None |
| 255 | `radius` | `ggd-absent` | `A07C` | 39-00 無名神風流-玄武 | `godie-u00h.passive` | 50.0 | None |
| 256 | `radius` | `ggd-absent` | `A0G5` | 74-04 最終殞落星 | `godie-u00j.r` | 600.0 | None |
| 257 | `radius` | `ggd-absent` | `A0HJ` | 71-03 厄夜靈魂 | `godie-u00k.e` | 250.0 | None |
| 258 | `radius` | `ggd-absent` | `A0HK` | 71-04 萬惡歸宗 | `godie-u00k.r` | 600.0 | None |
| 259 | `radius` | `ggd-absent` | `A0HI` | 71-02 魔力反噬 | `godie-u00k.w` | 600.0 | None |
| 260 | `radius` | `ggd-absent` | `AEah` | 25-04 北斗神拳究極奧義 - 無想轉生 | `godie-u00l.r` | 50.0 | None |
| 261 | `radius` | `ggd-absent` | `A0IV` | 76-03 伸縮自如的槍亂打 | `godie-u00n.e` | 400.0 | None |
| 262 | `radius` | `ggd-absent` | `A0ZK` | 76-002 霸王色 | `godie-u00n.ex` | 0.0 | None |
| 263 | `radius` | `ggd-absent` | `A09I` | 38-03 邪王炎殺黑龍波 | `godie-u010.e` | 175.0 | None |
| 264 | `radius` | `ggd-absent` | `A09K` | 38-04 黑龍波吸收 | `godie-u010.r` | 5.0 | None |
| 265 | `radius` | `ggd-absent` | `A0OU` | 11-00 三刀流 | `godie-u01u.passive` | 0.0 | None |
| 266 | `radius` | `ggd-absent` | `A0BC` | 11-01 燒鬼斬 | `godie-u01u.q` | 350.0 | None |
| 267 | `radius` | `ggd-absent` | `A0OY` | 37-02 黑核晶 | `godie-ubal.e` | 400.0 | None |
| 268 | `radius` | `ggd-absent` | `A01I` | 37-01 凱薩之鷹 | `godie-ubal.q` | 200.0 | None |
| 269 | `radius` | `ggd-absent` | `A01X` | 37-04-02 凱薩之鷹 | `godie-ubal.r` | 170.0 | None |
| 270 | `radius` | `ggd-absent` | `A0KC` | 37-03 災難之牆 | `godie-ubal.w` | 1.0 | None |
| 271 | `radius` | `ggd-absent` | `A0KD` | 37-03-00 災難之牆火燄 | `godie-ubal.w` | 150.0 | None |
| 272 | `radius` | `ggd-absent` | `A05S` | 65-02 寒冰破碎 | `godie-udea.w` | 200.0 | None |
| 273 | `duration` | `free-number` | `A02Q` | 22-04 雛見澤症候群L5 | `godie-e001.r` | 0.0 | 7.0 |
| 274 | `duration` | `free-number` | `A0ZO` | 70-04 樹海降臨 | `godie-e00s.r` | 0.0 | 8.0 |
| 275 | `duration` | `free-number` | `A102` | 45-002 天照 | `godie-edem.ex` | 0.01 | 10.0 |
| 276 | `duration` | `free-number` | `A0M7` | 45-01 火遁-豪火龍之術 | `godie-edem.q` | 0.01 | 3.0 |
| 277 | `duration` | `free-number` | `A0ZT` | 15-002-00 風花武裝解除BUFF | `godie-emfr.ex` | 4.0 | 5.0 |
| 278 | `duration` | `free-number` | `A0ZU` | 15-002 風花-武裝解除 | `godie-emfr.ex` | 0.01 | 5.0 |
| 279 | `duration` | `free-number` | `A0JZ` | 14-04 AKT戰隊 | `godie-etyr.r` | 0.1 | 8.0 |
| 280 | `duration` | `free-number` | `A0K2` | 14-04-03 涼宮禁言 | `godie-etyr.r` | 5.0 | 8.0 |
...
| 307 | `duration` | `free-number` | `A08Y` | 06-00 猜猜拳 | `godie-u034.passive` | 0.01 | 8.0 |
| 308 | `duration` | `free-number` | `A0SN` | 06-00x 石頭暈 | `godie-u034.passive` | 1.0 | 8.0 |
| 309 | `duration` | `free-number` | `A0Y1` | 06-04 傑桑變化 | `godie-u034.r` | 0.0 | 8.0 |
...
| 482 | `duration` | `ggd-absent` | `A08W` | 06-02 山形修煉-變 | `godie-u034.w` | 0.0 | None |
| 483 | `duration` | `ggd-absent` | `A0ZV` | 37-002 真‧黑核晶 | `godie-ubal.ex` | 0.01 | None |
| 484 | `duration` | `ggd-absent` | `S001` | 37-00 鬼眼 | `godie-ubal.passive` | 5.0 | None |
| 485 | `duration` | `ggd-absent` | `A01Z` | 37-04 魔界之王 | `godie-ubal.r` | 35.0 | None |
| 486 | `duration` | `ggd-absent` | `A0OT` | 37-04-01 魔力操控 | `godie-ubal.r` | 3.0 | None |
| 487 | `duration` | `ggd-absent` | `A0CH` | 65-03 魔法膨脹 | `godie-udea.e` | 1.0 | None |
| 488 | `duration` | `ggd-absent` | `A0FF` | 65-002 永恆的愚蠢鄉 | `godie-udea.ex` | 0.01 | None |
