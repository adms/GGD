...
| 250 | `radius` | `ggd-absent` | `A11C` | 99-04 世界第一的公主殿下 | `godie-o02p.r` | 225.0 | None |
| 251 | `radius` | `ggd-absent` | `A11D` | 99-04a 甩蔥歌 | `godie-o02p.r` | 400.0 | None |
| 252 | `radius` | `ggd-absent` | `A10I` | 30-002 EX變態針刺 | `godie-o030.ex` | 100.0 | None |
| 253 | `radius` | `ggd-absent` | `A01P` | 30-04 電車之狼衝擊 | `godie-o030.r` | 350.0 | None |
| 254 | `radius` | `ggd-absent` | `ANdh` | 30-02 酒精灌腸 | `godie-o030.w` | 600.0 | None |
| 255 | `radius` | `ggd-absent` | `ANmo` | 72-01洗刷刷 | `godie-ogld.q` | 350.0 | None |
| 256 | `radius` | `ggd-absent` | `ACdr` | 34-00 靈魂吞噬 | `godie-osam.passive` | 350.0 | None |
| 257 | `radius` | `ggd-absent` | `A034` | 34-01 風華之爪 | `godie-osam.q` | 260.0 | None |
| 258 | `radius` | `ggd-absent` | `A0FP` | 34-04 奧義˙蒼龍破 | `godie-osam.r` | 350.0 | None |
| 259 | `radius` | `ggd-absent` | `A0DO` | 39-03 無名神風流-蛟龍 | `godie-u00h.e` | 1.0 | None |
| 260 | `radius` | `ggd-absent` | `A07C` | 39-00 無名神風流-玄武 | `godie-u00h.passive` | 50.0 | None |
| 261 | `radius` | `ggd-absent` | `A0G5` | 74-04 最終殞落星 | `godie-u00j.r` | 600.0 | None |
| 262 | `radius` | `ggd-absent` | `A0HJ` | 71-03 厄夜靈魂 | `godie-u00k.e` | 250.0 | None |
| 263 | `radius` | `ggd-absent` | `A0HK` | 71-04 萬惡歸宗 | `godie-u00k.r` | 600.0 | None |
| 264 | `radius` | `ggd-absent` | `A0HI` | 71-02 魔力反噬 | `godie-u00k.w` | 600.0 | None |
| 265 | `radius` | `ggd-absent` | `AEah` | 25-04 北斗神拳究極奧義 - 無想轉生 | `godie-u00l.r` | 50.0 | None |
| 266 | `radius` | `ggd-absent` | `A0IV` | 76-03 伸縮自如的槍亂打 | `godie-u00n.e` | 400.0 | None |
| 267 | `radius` | `ggd-absent` | `A0ZK` | 76-002 霸王色 | `godie-u00n.ex` | 0.0 | None |
| 268 | `radius` | `ggd-absent` | `A09I` | 38-03 邪王炎殺黑龍波 | `godie-u010.e` | 175.0 | None |
| 269 | `radius` | `ggd-absent` | `A09K` | 38-04 黑龍波吸收 | `godie-u010.r` | 5.0 | None |
| 270 | `radius` | `ggd-absent` | `A0OU` | 11-00 三刀流 | `godie-u01u.passive` | 0.0 | None |
| 271 | `radius` | `ggd-absent` | `A0BC` | 11-01 燒鬼斬 | `godie-u01u.q` | 350.0 | None |
| 272 | `radius` | `ggd-absent` | `A0NP` | 06-00x 剪刀出血 | `godie-u034.passive` | 0.0 | None |
| 273 | `radius` | `ggd-absent` | `A0OY` | 37-02 黑核晶 | `godie-ubal.e` | 400.0 | None |
| 274 | `radius` | `ggd-absent` | `A01I` | 37-01 凱薩之鷹 | `godie-ubal.q` | 200.0 | None |
| 275 | `radius` | `ggd-absent` | `A01X` | 37-04-02 凱薩之鷹 | `godie-ubal.r` | 170.0 | None |
| 276 | `radius` | `ggd-absent` | `A0KC` | 37-03 災難之牆 | `godie-ubal.w` | 1.0 | None |
| 277 | `radius` | `ggd-absent` | `A0KD` | 37-03-00 災難之牆火燄 | `godie-ubal.w` | 150.0 | None |
| 278 | `radius` | `ggd-absent` | `A05S` | 65-02 寒冰破碎 | `godie-udea.w` | 200.0 | None |
| 279 | `duration` | `free-number` | `A02Q` | 22-04 雛見澤症候群L5 | `godie-e001.r` | 0.0 | 7.0 |
...
| 306 | `duration` | `ggd-absent` | `AEsh` | 22-03 五吋釘 | `godie-e001.e` | 5.0 | None |
| 307 | `duration` | `ggd-absent` | `A0SU` | 22-002 月光下的決鬥者 | `godie-e001.ex` | 0.3 | None |
| 308 | `duration` | `ggd-absent` | `A0SV` | 22-002 月光下的決鬥者 | `godie-e001.ex` | 0.3 | None |
| 309 | `duration` | `ggd-absent` | `A0CL` | 22-00 嗚鎖打! | `godie-e001.passive` | 0.5 | None |
| 310 | `duration` | `ggd-absent` | `A007` | 22-01 鬼隱之擊 | `godie-e001.q` | 12.0 | None |
| 311 | `duration` | `ggd-absent` | `A0CT` | 20-04 Avalon-永恆的理想鄉 | `godie-e002.r` | 0.01 | None |
| 312 | `duration` | `ggd-absent` | `A0DZ` | 20-01 風王結界 | `godie-e002.w` | 0.0 | None |
| 313 | `duration` | `ggd-absent` | `A02W` | 12-03 破凰之心-徒手空破山 | `godie-e007.e` | 0.0 | None |
| 314 | `duration` | `ggd-absent` | `A04Y` | 12-01 鬥仙術 | `godie-e007.q` | 1.0 | None |
| 315 | `duration` | `ggd-absent` | `A04X` | 12-04 龍氣爆發 | `godie-e007.r` | 3.0 | None |
| 316 | `duration` | `ggd-absent` | `A0BF` | 21-03 赤焰爆發 | `godie-e008.e` | 1.0 | None |
| 317 | `duration` | `ggd-absent` | `A0UO` | 21-002 天破壤碎 | `godie-e008.ex` | 0.01 | None |
| 318 | `duration` | `ggd-absent` | `A0V9` | 21-002-03-x 天破 | `godie-e008.ex` | 0.01 | None |
| 319 | `duration` | `ggd-absent` | `A0BD` | 21-02 拔焰刀 | `godie-e008.q` | 0.5 | None |
| 320 | `duration` | `ggd-absent` | `A0HB` | 21-04 討滅封絕 | `godie-e008.r` | 0.01 | None |
| 321 | `duration` | `ggd-absent` | `A0BH` | 21-01 火羽 | `godie-e008.w` | 6.0 | None |
| 322 | `duration` | `ggd-absent` | `A0O5` | 59-01 吞噬 | `godie-e00r.q` | 9.0 | None |
| 323 | `duration` | `ggd-absent` | `A0GF` | 59-02 高週波短刀 | `godie-e00r.w` | 0.5 | None |
| 324 | `duration` | `ggd-absent` | `A0GR` | 70-03 木束縛之術 | `godie-e00s.e` | 0.0 | None |
| 325 | `duration` | `ggd-absent` | `A0GS` | 70-03-01 木束縛 | `godie-e00s.e` | 1.5 | None |
| 326 | `duration` | `ggd-absent` | `A0O6` | 70-00 紮根 | `godie-e00s.passive` | 0.0 | None |
| 327 | `duration` | `ggd-absent` | `A0GP` | 70-01 伸卡球 | `godie-e00s.q` | 1.0 | None |
| 328 | `duration` | `ggd-absent` | `A0ZO` | 70-04 樹海降臨 | `godie-e00s.r` | 0.0 | None |
| 329 | `duration` | `ggd-absent` | `A0GQ` | 70-02 大怒石 | `godie-e00s.w` | 0.4 | None |
| 330 | `duration` | `ggd-absent` | `A0JG` | 77-03 GLADIARIA ALAT | `godie-e00w.e` | 0.0 | None |
| 331 | `duration` | `ggd-absent` | `A10G` | 77-002 御雷劍 | `godie-e00w.ex` | 15.0 | None |
| 332 | `duration` | `ggd-absent` | `A0JD` | 77-00 浮雲-旋一閃 | `godie-e00w.passive` | 0.5 | None |
| 333 | `duration` | `ggd-absent` | `A0TV` | 77-01 百烈櫻華斬 | `godie-e00w.q` | 1.0 | None |
| 334 | `duration` | `ggd-absent` | `A0JE` | 77-04 真-雷光劍 | `godie-e00w.r` | 4.0 | None |
| 335 | `duration` | `ggd-absent` | `A0JB` | 77-02 百烈櫻華斬 | `godie-e00w.w` | 0.01 | None |
| 336 | `duration` | `ggd-absent` | `A0TY` | 77-02-01 雷鳴劍落雷 | `godie-e00w.w` | 0.01 | None |
| 337 | `duration` | `ggd-absent` | `A0JX` | 45-02 千鳥流 | `godie-edem.w` | 1.5 | None |
| 338 | `duration` | `ggd-absent` | `AEtq` | 13-03 快步 | `godie-efur.e` | 0.01 | None |
| 339 | `duration` | `ggd-absent` | `A10H` | 13-002 化龍 | `godie-efur.ex` | 2.0 | None |
| 340 | `duration` | `ggd-absent` | `A10S` | 13-002 KISS ME! | `godie-efur.ex` | 0.01 | None |
| 341 | `duration` | `ggd-absent` | `A10T` | 13-0021 KISS | `godie-efur.ex` | 0.01 | None |
| 342 | `duration` | `ggd-absent` | `Auhf` | 13-00 狂氣 | `godie-efur.passive` | 9.0 | None |
| 343 | `duration` | `ggd-absent` | `AEer` | 13-01 老樹盤根 | `godie-efur.q` | 1.0 | None |
| 344 | `duration` | `ggd-absent` | `A00X` | 13-02 變化念力 | `godie-efur.w` | 1.0 | None |
| 345 | `duration` | `ggd-absent` | `A052` | 15-03 雷電風暴 | `godie-emfr.e` | 2.0 | None |
| 346 | `duration` | `ggd-absent` | `A056` | 15-01-01 風精召喚 | `godie-emfr.q` | 2.0 | None |
| 347 | `duration` | `ggd-absent` | `A054` | 15-02 沉睡之霧 | `godie-emfr.w` | 3.0 | None |
| 348 | `duration` | `ggd-absent` | `A05H` | 44-03 火車輾過 | `godie-emns.e` | 0.0 | None |
| 349 | `duration` | `ggd-absent` | `A0SA` | 44-002 交換筆記本 | `godie-emns.ex` | 0.2 | None |
| 350 | `duration` | `ggd-absent` | `A0IK` | 44-01 死神之眼 | `godie-emns.q` | 15.0 | None |
| 351 | `duration` | `ggd-absent` | `A05I` | 44-04 心臟麻痺 | `godie-emns.r` | 1.0 | None |
| 352 | `duration` | `ggd-absent` | `A0JM` | 14-02 式神炸裂 | `godie-etyr.e` | 0.01 | None |
| 353 | `duration` | `ggd-absent` | `A0JJ` | 14-00 召喚式神 | `godie-etyr.passive` | 25.0 | None |
| 354 | `duration` | `ggd-absent` | `A0JK` | 14-00-01 式神之火 | `godie-etyr.passive` | 1.0 | None |
| 355 | `duration` | `ggd-absent` | `A0JY` | 14-00-01 式神之火 | `godie-etyr.passive` | 1.0 | None |
| 356 | `duration` | `ggd-absent` | `A0JL` | 14-01 東風繪扇、南風末廣 | `godie-etyr.q` | 0.01 | None |
| 357 | `duration` | `ggd-absent` | `A0JZ` | 14-04 AKT戰隊 | `godie-etyr.r` | 0.1 | None |
| 358 | `duration` | `ggd-absent` | `A0K2` | 14-04-03 涼宮禁言 | `godie-etyr.r` | 5.0 | None |
| 359 | `duration` | `ggd-absent` | `A0SS` | 14-04 聖夜降臨 | `godie-etyr.r` | 8.0 | None |
...
| 373 | `duration` | `ggd-absent` | `A021` | 04-02 炸彈陣 | `godie-h020.w` | 5.0 | None |
...
| 379 | `duration` | `ggd-absent` | `A0KV` | 90-00 寄生種子 | `godie-h02r.passive` | 5.1 | None |
| 380 | `duration` | `ggd-absent` | `A0VC` | 90-01 保護色獵殺 | `godie-h02r.q` | 12.0 | None |
| 381 | `duration` | `ggd-absent` | `AOww` | 90-01 飛葉快刀 | `godie-h02r.q` | 2.0 | None |
...
| 395 | `duration` | `ggd-absent` | `A03T` | 28-03 分身 | `godie-huth.e` | 10.0 | None |
