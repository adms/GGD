...
> | | |
> |---|---|
> | **量測時間** | **2026-08-12**（B1/B2 開工**之前**） |
> | **量測時的版本** | **v0.14.3** |
> | **最後更新** | 2026-08-13（B1–B4 + 最慘 5 支收尾）|
> | **對應版本** | **v0.14.7**（見文末「修復進度」）—— ⚠️ 上方涵蓋率那幾格**仍是 08-12 的基準線** |
>
> ⛔ **不要拿這份的 71.5% 當現況。** 它是**修之前**的基準線，留著是為了對照。
> 現況看 [`_skill-remake-batch1-缺陷歸類.md`](_skill-remake-batch1-缺陷歸類.md) 的修復進度，
> 以及本檔末尾的「修復進度」一節。
>
> ⭐ 判斷這份有沒有過期的方法：**它的「對應版本」比 `git describe --tags` 舊，就是舊的。**
...
# 修復進度（2026-08-13 · v0.14.6→v0.14.7）
