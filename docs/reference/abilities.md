...
| `godie-e007.ex` | 12-002 仙氣發勁 | EX | 主動攻擊 | 12-002 | `godie-e007` 天地志狼 | — | 天地志狼在近身的最後必殺絕技，將身上所有的仙氣集中在手上瞬間爆發造成500點傷害。 |
...
| `godie-e00x.passive` | 77-00 浮雲-旋一閃 | PASSIVE | 天生·主動 | 77-00 | `godie-e00x` 櫻綻剎那 | — | 神鳴流的體術招式之一，閃過敵人攻擊，抓住對手後，旋轉拋摔。（每次發動限一人且為英雄）持續時間0.5秒，造成500點傷害。 |
...
| `godie-h02u.e` | 92-03 消化液 | E | 主動攻擊 | 92-03 | `godie-h02u` 草泥馬 | — | 羊駝在驚嚇或憤怒的時候，會從嘴巴裡噴出消化液攻擊敵人，造成範圍內敵人減少3點防禦、20%攻速、5%跑速，每秒受到500點傷… |
...
| `godie-u00v.r` | 78-04 死亡噴射肘擊 | R | 主動攻擊 | 78-04 | `godie-u00v` 基廉列克 | ✅ | 在基廉列克發怒的時候，將會使出意外的致命一擊，超快速速飛奔到敵人面前，使用肘擊敵方造成500點傷害，擊退目標1000距離，… |
