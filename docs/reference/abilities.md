...
| `godie-etyr.q` | 14-01 東風繪扇、南風末廣 | Q | 輔助 | 14-01 | `godie-etyr` 木乃香 | ✅ | 揮動兩把具有神奇魔力的扇子，使我方範圍300內單位解除異常狀態，並且回復生命力150+71.11% [AP]點。 |
...
| `godie-h01o.w` | 79-02 斬擊 | W | 被動 | 79-02 | `godie-h01o` 黑崎一護 | — | 將月牙的能量聚集在斬月上，在攻擊敵人的同時釋放出，給予目標額外100+293.83% [AP]點傷害。 |
...
| `godie-o00x.r` | 09-04 龜派氣功 | R | 主動攻擊 | 09-04 | `godie-o00x` 悟空 | — | 源自武天老師的絕學，將氣集中在手上，累積成強烈氣旋後發射，造成一直線上敵方部隊625/1250/1875+150.09%… |
...
| `godie-ogld.r` | 72-04 黑化 | R | 主動攻擊 | 72-04 | `godie-ogld` 黑人牙膏 | ✅ | 黑化後的黑人牙膏將會在短時間內使出敵我皆傷的噴牙膏攻擊，對周圍所有生物造成最多121.91% [AP]的傷害。 |
...
| `godie-ogrh.r` | 09-04 龜派氣功 | R | 主動攻擊 | 09-04 | `godie-ogrh` 悟空 | ✅ | 源自武天老師的絕學，將氣集中在手上，累積成強烈氣旋後發射，造成一直線上敵方部隊625/1250/1875+150.09%… |
...
| `godie-u00h.r` | 39-04 祕奧義．金色的神風 | R | 主動攻擊 | 39-04 | `godie-u00h` 鬼畜狂刀KYO | ✅ | 同時召喚出四神時所同時發動的最終奧義，將帶給接近鬼眼狂刀的人333+57.47% [AP]傷害並暈眩1秒，並且招換四神造成… |
...
| `godie-u00j.w` | 74-02 八刀一閃 | W | 主動攻擊 | 74-02 | `godie-u00j` 賽菲洛斯 | ✅ | 極快的速度衝刺到敵人面前，給予週遭敵人42.89% [AP]+150傷害。 |
...
| `godie-u00l.q` | 25-01 北斗懺悔拳 | Q | 主動攻擊 | 25-01 | `godie-u00l` 拳四郎 | — | "你還有3秒的時間可以懺悔你這輩子的罪孽"，點擊指定單位之秘穴，在三秒後造成自身84.66% [AP]+150傷害。 |
...
| `godie-u034.passive` | 06-00 猜猜拳 | PASSIVE | 天生·主動 | 06-00 | `godie-u034` 傑 富力士 | — | 消耗MP75 |
...
| `godie-ucrl.passive` | 06-00 猜猜拳 | PASSIVE | 天生·主動 | 06-00 | `godie-ucrl` 傑 富力士 | — | 消耗MP75 |
...
| `godie-umal.q` | 25-01 北斗懺悔拳 | Q | 主動攻擊 | 25-01 | `godie-umal` 拳四郎 | ✅ | "你還有3秒的時間可以懺悔你這輩子的罪孽"，點擊指定單位之秘穴，在三秒後造成自身84.66% [AP]+150傷害。 |
