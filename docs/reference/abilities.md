...
> 資料列：**420**　·　開放名單來源：`data/curation/whitelist.json`（updatedAt `2026-08-19T20:57:12.386323Z`）
...
| `godie-udea.r` | 65-04 天譴 | R | 主動攻擊 | 65-04 | `godie-udea` 飛鼠先生 | ✅ | 怒氣凝聚為閃電，向前衝鋒，同時朝周圍的敵人放電。範圍內的敵人（最多20名）各自引爆一條獨立的連鎖閃電：第一發造成150點傷… |
