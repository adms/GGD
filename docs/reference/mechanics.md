...
contentVersion `cv_5c6a1513c360`
...
| `spawnModelFx` | 模型特效（帶模型的單位沿路徑移動 —— 光束／砲擊／衝擊波） | 32 | `godie-e002.e`、`godie-e002.r`、`godie-e00l.e`、`godie-e00l.r`、`godie-e00r.r`、`godie-e00w.r`、`godie-e00x.q`、`godie-e00x.r`、`godie-edem.e`、`godie-emfr.e`、`godie-emfr.r`、`godie-etyr.q` …（共 32） |
