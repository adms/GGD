...
import { SKELETON_ARENA } from "@ggd/shared/sim/arena";
import { spawnChampion } from "@ggd/shared/sim/spawn";
import { castAbility } from "@ggd/shared/sim/abilities/abilitySystem";
import { asSeatId, asTeamId, type ChampionId, type AbilityId } from "@ggd/shared/ids";
import { ContentLoader } from "@ggd/shared/content/loader";
import { shippedContentSource } from "@ggd/shared/content/sources";
import {
  registerAll,
  Champions,
  Abilities,
