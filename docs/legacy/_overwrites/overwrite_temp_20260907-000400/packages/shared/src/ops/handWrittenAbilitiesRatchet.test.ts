 ...
 * · ⭐ 預期（#1066 #1069 #1071 #1072 #1073 的 expand.ts 家族落地後，`templatize.py --apply`）：
 *   再收 34 支（single-strike＋status 17 · heal 5 · blink 5 · apply-status 4 · drain-leech 3）⇒ **207**；
 *   n01g.q（要拿掉 baseline 的 42-01|effects）與 u01u.e／udre.e（別條 lane 的檔）另加 3 ⇒ 204。
 */
