 ...
 * is guarded on CONTENT too — ⛔ no literal number baked into a line (第〇·四守則:
 * turn `statTickTarget` and the merchant must turn with it), every placeholder
 * resolves, every row names where its mechanic lives, every topic covered.
 */
