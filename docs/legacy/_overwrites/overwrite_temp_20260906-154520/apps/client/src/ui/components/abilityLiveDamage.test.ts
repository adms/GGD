...
import { abilityQuantities } from "@ggd/shared/content/abilityProse";
...
describe("GH#1039 卡面「（目前 N）」", () => {
  it("大氣之刃：目前 N ＝ 卡面基礎 × apCurveMult；有法強 ⇒ ≠ 基礎；開關關 ⇒ 逐位元同今天", () => {
    const def = Abilities.get("godie-e007.e" as AbilityId);
