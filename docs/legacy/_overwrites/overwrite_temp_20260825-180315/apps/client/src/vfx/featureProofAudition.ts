...
const CLASSICS: Record<string, ClassicSpec> = {
  ...
  omnislash: {
    ...
    beats: [
      ...
      { label: "o2_resolve", ticks: 2, until: { type: "vfxSpawn", nth: 1, max: 120 }, note: "詠唱解算後的**第一記斬擊**（等 vfxSpawn ⇒ ⛔ 不猜 tick）：無敵 3.5 秒＋鎖定敵人" },
      ...
      { label: "o4_combo_finish", ticks: 1, until: { type: "vfxSpawn", nth: 5, max: 220 }, note: "收尾一擊：warstompcaster ＋ screenFlash ＋ screenShake" },
      { label: "o5_expired", ticks: 60, note: "到期：3.5 秒鎖定與無敵結束，畫面回到只有替身" },
