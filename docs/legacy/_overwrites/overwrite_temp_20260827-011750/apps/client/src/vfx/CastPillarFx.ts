...
export class CastPillarFx {
  ...
  private readonly charge: CastChargeFx;
  ...
  constructor(
    ...
    this.charge = new CastChargeFx(scene, this.deps, { getScale: this.getScale });
  }

  /** ⭐ GH#788 —— 蓄力集氣那一層（測試／觀測接縫）。 */
  get chargeFx(): CastChargeFx {
    return this.charge;
  }
