...
/** `spawnModelFx.anchor` 的值域 —— 從 sim 的型別推導，⛔ 不是第五份手抄。 */
type ModelFxAnchor = NonNullable<Extract<EffectDef, { kind: "spawnModelFx" }>["anchor"]>;
...
export function mergeExpansion(
  ...
  for (const k of COMPOSABLE_KEYS) delete out[k]; // MUTATION-1065: 改回舊的先全刪
