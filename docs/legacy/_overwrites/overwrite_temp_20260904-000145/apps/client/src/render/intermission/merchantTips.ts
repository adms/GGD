...
export const TIP_VALUES: Readonly<Record<string, number | string | undefined>> = {
  ...
  teamSize: TEAM_SIZE,
  duelCount: TEAM_COUNT / TEAM_SIZE >= 1 ? TEAM_COUNT / 2 : 1,
...
export const MERCHANT_TIP_TEMPLATES: readonly MerchantTipTemplate[] = [
  ...
  },
  {
    kind: "rule",
    topic: "format",
    text: "隊伍血條被扣光**不會讓你出局**——比賽照樣打滿 {{finalRound}} 個回合才分勝負。",
    source: "config.arena-rules@1 finalRound；match.ts 取消淘汰（owner 2026-07-27）",
  },
  {
    kind: "rule",
    topic: "round",
  ...
  },
  {
    kind: "tip",
    topic: "team",
    text: "兩場對戰是分開的，但商店與強化是你自己的——別為了看熱鬧丟掉整備時間。",
