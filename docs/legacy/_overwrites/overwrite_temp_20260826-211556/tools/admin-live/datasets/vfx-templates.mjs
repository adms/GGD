...
export async function build(repoRoot) {
  ...
  return {
    ...
    honest: [
      ...
      "model@1 沒有 fxAlpha 欄位（全 141 份 union 量過）；透明度住節點級 alpha 與粒子家族的 alpha。fxTint 只有 2 份 model doc 有。",
      "只掃 content/abilities/（331 份標準本）；content/champions/ 的鏡射副本不重複掃（鏡射同步守衛保證同值）。",
